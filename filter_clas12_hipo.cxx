...
//
///  FD eid cuts:  0 = negative charge,  1 = PID default, 2 = PID + charge + EC inner vs outer,  3 = PID + charge + EC
///  samp. frac.,  4 = PID + charge + PCAL hit pos. fiducial,
///                5 = PID + charge + DC fiducial region 1,  6 = PID + charge + DC fiducial region 3,  7 = PID + charge
///                + DC z vertex, 8 = all cuts passed, except the one based on the shown histogram, 9 = all cuts,  10 =
///                inverse PID cut
///
///  FD hadron ID cuts:  0 = PID default,  1 = charge,   2 = DC fiducial region 1,    3 = DC fiducial region 3,   8 =
///  delta vz, 9 = all
///                      --> cuts 3 to 8 contain charge and DC fiducial cut as basis, for neutrons, the DC fiducial cut
///                      is not applied
///                      --> For negative pions and Kaons also a a cut, requireing, that the particle is not a correctly
///                      identified electron is applied to cut 1 - 7
...
///
///  CD hadron ID:  0 = PID default,   1 = charge,   2 = PID + charge + beta vs p,   3 = PID + charge + maximum
///  probability,   4 = PID + charge + z vertex,  5 = all cuts
///
...
int ele_detect[BUFFER], prot_detect[BUFFER], neutr_detect[BUFFER], pip_detect[BUFFER], pim_detect[BUFFER],
    Kp_detect[BUFFER], Km_detect[BUFFER], phot_detect[BUFFER];
int ele_sector[BUFFER], prot_sector[BUFFER], neutr_sector[BUFFER], pip_sector[BUFFER], pim_sector[BUFFER],
    Kp_sector[BUFFER], Km_sector[BUFFER], phot_sector[BUFFER];
float ele_chi2pid[BUFFER], prot_chi2pid[BUFFER], neutr_chi2pid[BUFFER], pip_chi2pid[BUFFER], pim_chi2pid[BUFFER],
    Kp_chi2pid[BUFFER], Km_chi2pid[BUFFER];
...
float part_Cal_PCAL_energy[BUFFER], part_Cal_ECin_energy[BUFFER], part_Cal_ECout_energy[BUFFER],
    part_Cal_energy_total[BUFFER];
...
float part_FT_energy[BUFFER], part_FT_radius[BUFFER], part_FTHODO_time[BUFFER], part_FTHODO_path[BUFFER],
    part_FTCAL_time[BUFFER], part_FTCAL_path[BUFFER];
...
int e_ind[BUFFER], p_ind[BUFFER], n_ind[BUFFER], pip_ind[BUFFER], pim_ind[BUFFER], Kp_ind[BUFFER], Km_ind[BUFFER],
    g_ind[BUFFER];
...
Int_t filter_clas12_hipo(Char_t* inFile, Char_t* outputfile, int run) {
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1 =
      new TH2F("PCAL_vs_ECin_sampling_fraction_sec1", "PCAL_vs_ECin_sampling_fraction_sec1", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2 =
      new TH2F("PCAL_vs_ECin_sampling_fraction_sec2", "PCAL_vs_ECin_sampling_fraction_sec2", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3 =
      new TH2F("PCAL_vs_ECin_sampling_fraction_sec3", "PCAL_vs_ECin_sampling_fraction_sec3", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4 =
      new TH2F("PCAL_vs_ECin_sampling_fraction_sec4", "PCAL_vs_ECin_sampling_fraction_sec4", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5 =
      new TH2F("PCAL_vs_ECin_sampling_fraction_sec5", "PCAL_vs_ECin_sampling_fraction_sec5", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6 =
      new TH2F("PCAL_vs_ECin_sampling_fraction_sec6", "PCAL_vs_ECin_sampling_fraction_sec6", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_cut_sec1 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_cut_sec1", "PCAL_vs_ECin_sampling_fraction_cut_sec1", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_cut_sec2 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_cut_sec2", "PCAL_vs_ECin_sampling_fraction_cut_sec2", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_cut_sec3 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_cut_sec3", "PCAL_vs_ECin_sampling_fraction_cut_sec3", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_cut_sec4 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_cut_sec4", "PCAL_vs_ECin_sampling_fraction_cut_sec4", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_cut_sec5 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_cut_sec5", "PCAL_vs_ECin_sampling_fraction_cut_sec5", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_cut_sec6 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_cut_sec6", "PCAL_vs_ECin_sampling_fraction_cut_sec6", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_pion_sec1 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_pion_sec1", "PCAL_vs_ECin_sampling_fraction_pion_sec1", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_pion_sec2 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_pion_sec2", "PCAL_vs_ECin_sampling_fraction_pion_sec2", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_pion_sec3 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_pion_sec3", "PCAL_vs_ECin_sampling_fraction_pion_sec3", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_pion_sec4 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_pion_sec4", "PCAL_vs_ECin_sampling_fraction_pion_sec4", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_pion_sec5 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_pion_sec5", "PCAL_vs_ECin_sampling_fraction_pion_sec5", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_pion_sec6 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_pion_sec6", "PCAL_vs_ECin_sampling_fraction_pion_sec6", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1_p23 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec1_p23", "PCAL_vs_ECin_sampling_fraction_sec1_p23", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1_p34 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec1_p34", "PCAL_vs_ECin_sampling_fraction_sec1_p34", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1_p45 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec1_p45", "PCAL_vs_ECin_sampling_fraction_sec1_p45", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1_p56 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec1_p56", "PCAL_vs_ECin_sampling_fraction_sec1_p56", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1_p67 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec1_p67", "PCAL_vs_ECin_sampling_fraction_sec1_p67", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1_p78 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec1_p78", "PCAL_vs_ECin_sampling_fraction_sec1_p78", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1_p89 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec1_p89", "PCAL_vs_ECin_sampling_fraction_sec1_p89", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec1_p9 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec1_p9", "PCAL_vs_ECin_sampling_fraction_sec1_p9", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2_p23 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec2_p23", "PCAL_vs_ECin_sampling_fraction_sec2_p23", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2_p34 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec2_p34", "PCAL_vs_ECin_sampling_fraction_sec2_p34", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2_p45 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec2_p45", "PCAL_vs_ECin_sampling_fraction_sec2_p45", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2_p56 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec2_p56", "PCAL_vs_ECin_sampling_fraction_sec2_p56", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2_p67 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec2_p67", "PCAL_vs_ECin_sampling_fraction_sec2_p67", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2_p78 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec2_p78", "PCAL_vs_ECin_sampling_fraction_sec2_p78", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2_p89 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec2_p89", "PCAL_vs_ECin_sampling_fraction_sec2_p89", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec2_p9 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec2_p9", "PCAL_vs_ECin_sampling_fraction_sec2_p9", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3_p23 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec3_p23", "PCAL_vs_ECin_sampling_fraction_sec3_p23", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3_p34 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec3_p34", "PCAL_vs_ECin_sampling_fraction_sec3_p34", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3_p45 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec3_p45", "PCAL_vs_ECin_sampling_fraction_sec3_p45", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3_p56 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec3_p56", "PCAL_vs_ECin_sampling_fraction_sec3_p56", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3_p67 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec3_p67", "PCAL_vs_ECin_sampling_fraction_sec3_p67", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3_p78 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec3_p78", "PCAL_vs_ECin_sampling_fraction_sec3_p78", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3_p89 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec3_p89", "PCAL_vs_ECin_sampling_fraction_sec3_p89", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec3_p9 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec3_p9", "PCAL_vs_ECin_sampling_fraction_sec3_p9", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4_p23 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec4_p23", "PCAL_vs_ECin_sampling_fraction_sec4_p23", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4_p34 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec4_p34", "PCAL_vs_ECin_sampling_fraction_sec4_p34", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4_p45 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec4_p45", "PCAL_vs_ECin_sampling_fraction_sec4_p45", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4_p56 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec4_p56", "PCAL_vs_ECin_sampling_fraction_sec4_p56", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4_p67 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec4_p67", "PCAL_vs_ECin_sampling_fraction_sec4_p67", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4_p78 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec4_p78", "PCAL_vs_ECin_sampling_fraction_sec4_p78", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4_p89 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec4_p89", "PCAL_vs_ECin_sampling_fraction_sec4_p89", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec4_p9 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec4_p9", "PCAL_vs_ECin_sampling_fraction_sec4_p9", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5_p23 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec5_p23", "PCAL_vs_ECin_sampling_fraction_sec5_p23", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5_p34 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec5_p34", "PCAL_vs_ECin_sampling_fraction_sec5_p34", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5_p45 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec5_p45", "PCAL_vs_ECin_sampling_fraction_sec5_p45", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5_p56 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec5_p56", "PCAL_vs_ECin_sampling_fraction_sec5_p56", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5_p67 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec5_p67", "PCAL_vs_ECin_sampling_fraction_sec5_p67", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5_p78 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec5_p78", "PCAL_vs_ECin_sampling_fraction_sec5_p78", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5_p89 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec5_p89", "PCAL_vs_ECin_sampling_fraction_sec5_p89", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec5_p9 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec5_p9", "PCAL_vs_ECin_sampling_fraction_sec5_p9", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6_p23 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec6_p23", "PCAL_vs_ECin_sampling_fraction_sec6_p23", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6_p34 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec6_p34", "PCAL_vs_ECin_sampling_fraction_sec6_p34", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6_p45 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec6_p45", "PCAL_vs_ECin_sampling_fraction_sec6_p45", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6_p56 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec6_p56", "PCAL_vs_ECin_sampling_fraction_sec6_p56", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6_p67 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec6_p67", "PCAL_vs_ECin_sampling_fraction_sec6_p67", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6_p78 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec6_p78", "PCAL_vs_ECin_sampling_fraction_sec6_p78", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6_p89 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec6_p89", "PCAL_vs_ECin_sampling_fraction_sec6_p89", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_PCAL_vs_ECin_sampling_fraction_sec6_p9 = new TH2F(
      "PCAL_vs_ECin_sampling_fraction_sec6_p9", "PCAL_vs_ECin_sampling_fraction_sec6_p9", 200, 0, 0.2, 300, 0, 0.3);
  ...
  hist_DC_edge_chi2_region1_sec1_ele =
      new TH2F("DC_edge_chi2_region1_sec1_ele", "DC_edge_chi2_region1_sec1_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec2_ele =
      new TH2F("DC_edge_chi2_region1_sec2_ele", "DC_edge_chi2_region1_sec2_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec3_ele =
      new TH2F("DC_edge_chi2_region1_sec3_ele", "DC_edge_chi2_region1_sec3_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec4_ele =
      new TH2F("DC_edge_chi2_region1_sec4_ele", "DC_edge_chi2_region1_sec4_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec5_ele =
      new TH2F("DC_edge_chi2_region1_sec5_ele", "DC_edge_chi2_region1_sec5_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec6_ele =
      new TH2F("DC_edge_chi2_region1_sec6_ele", "DC_edge_chi2_region1_sec6_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec1_ele =
      new TH2F("DC_edge_chi2_region2_sec1_ele", "DC_edge_chi2_region2_sec1_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec2_ele =
      new TH2F("DC_edge_chi2_region2_sec2_ele", "DC_edge_chi2_region2_sec2_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec3_ele =
      new TH2F("DC_edge_chi2_region2_sec3_ele", "DC_edge_chi2_region2_sec3_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec4_ele =
      new TH2F("DC_edge_chi2_region2_sec4_ele", "DC_edge_chi2_region2_sec4_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec5_ele =
      new TH2F("DC_edge_chi2_region2_sec5_ele", "DC_edge_chi2_region2_sec5_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec6_ele =
      new TH2F("DC_edge_chi2_region2_sec6_ele", "DC_edge_chi2_region2_sec6_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec1_ele =
      new TH2F("DC_edge_chi2_region3_sec1_ele", "DC_edge_chi2_region3_sec1_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec2_ele =
      new TH2F("DC_edge_chi2_region3_sec2_ele", "DC_edge_chi2_region3_sec2_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec3_ele =
      new TH2F("DC_edge_chi2_region3_sec3_ele", "DC_edge_chi2_region3_sec3_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec4_ele =
      new TH2F("DC_edge_chi2_region3_sec4_ele", "DC_edge_chi2_region3_sec4_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec5_ele =
      new TH2F("DC_edge_chi2_region3_sec5_ele", "DC_edge_chi2_region3_sec5_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec6_ele =
      new TH2F("DC_edge_chi2_region3_sec6_ele", "DC_edge_chi2_region3_sec6_ele", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec1_prot =
      new TH2F("DC_edge_chi2_region1_sec1_prot", "DC_edge_chi2_region1_sec1_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec2_prot =
      new TH2F("DC_edge_chi2_region1_sec2_prot", "DC_edge_chi2_region1_sec2_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec3_prot =
      new TH2F("DC_edge_chi2_region1_sec3_prot", "DC_edge_chi2_region1_sec3_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec4_prot =
      new TH2F("DC_edge_chi2_region1_sec4_prot", "DC_edge_chi2_region1_sec4_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec5_prot =
      new TH2F("DC_edge_chi2_region1_sec5_prot", "DC_edge_chi2_region1_sec5_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec6_prot =
      new TH2F("DC_edge_chi2_region1_sec6_prot", "DC_edge_chi2_region1_sec6_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec1_prot =
      new TH2F("DC_edge_chi2_region2_sec1_prot", "DC_edge_chi2_region2_sec1_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec2_prot =
      new TH2F("DC_edge_chi2_region2_sec2_prot", "DC_edge_chi2_region2_sec2_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec3_prot =
      new TH2F("DC_edge_chi2_region2_sec3_prot", "DC_edge_chi2_region2_sec3_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec4_prot =
      new TH2F("DC_edge_chi2_region2_sec4_prot", "DC_edge_chi2_region2_sec4_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec5_prot =
      new TH2F("DC_edge_chi2_region2_sec5_prot", "DC_edge_chi2_region2_sec5_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec6_prot =
      new TH2F("DC_edge_chi2_region2_sec6_prot", "DC_edge_chi2_region2_sec6_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec1_prot =
      new TH2F("DC_edge_chi2_region3_sec1_prot", "DC_edge_chi2_region3_sec1_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec2_prot =
      new TH2F("DC_edge_chi2_region3_sec2_prot", "DC_edge_chi2_region3_sec2_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec3_prot =
      new TH2F("DC_edge_chi2_region3_sec3_prot", "DC_edge_chi2_region3_sec3_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec4_prot =
      new TH2F("DC_edge_chi2_region3_sec4_prot", "DC_edge_chi2_region3_sec4_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec5_prot =
      new TH2F("DC_edge_chi2_region3_sec5_prot", "DC_edge_chi2_region3_sec5_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec6_prot =
      new TH2F("DC_edge_chi2_region3_sec6_prot", "DC_edge_chi2_region3_sec6_prot", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec1_pip =
      new TH2F("DC_edge_chi2_region1_sec1_pip", "DC_edge_chi2_region1_sec1_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec2_pip =
      new TH2F("DC_edge_chi2_region1_sec2_pip", "DC_edge_chi2_region1_sec2_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec3_pip =
      new TH2F("DC_edge_chi2_region1_sec3_pip", "DC_edge_chi2_region1_sec3_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec4_pip =
      new TH2F("DC_edge_chi2_region1_sec4_pip", "DC_edge_chi2_region1_sec4_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec5_pip =
      new TH2F("DC_edge_chi2_region1_sec5_pip", "DC_edge_chi2_region1_sec5_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec6_pip =
      new TH2F("DC_edge_chi2_region1_sec6_pip", "DC_edge_chi2_region1_sec6_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec1_pip =
      new TH2F("DC_edge_chi2_region2_sec1_pip", "DC_edge_chi2_region2_sec1_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec2_pip =
      new TH2F("DC_edge_chi2_region2_sec2_pip", "DC_edge_chi2_region2_sec2_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec3_pip =
      new TH2F("DC_edge_chi2_region2_sec3_pip", "DC_edge_chi2_region2_sec3_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec4_pip =
      new TH2F("DC_edge_chi2_region2_sec4_pip", "DC_edge_chi2_region2_sec4_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec5_pip =
      new TH2F("DC_edge_chi2_region2_sec5_pip", "DC_edge_chi2_region2_sec5_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec6_pip =
      new TH2F("DC_edge_chi2_region2_sec6_pip", "DC_edge_chi2_region2_sec6_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec1_pip =
      new TH2F("DC_edge_chi2_region3_sec1_pip", "DC_edge_chi2_region3_sec1_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec2_pip =
      new TH2F("DC_edge_chi2_region3_sec2_pip", "DC_edge_chi2_region3_sec2_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec3_pip =
      new TH2F("DC_edge_chi2_region3_sec3_pip", "DC_edge_chi2_region3_sec3_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec4_pip =
      new TH2F("DC_edge_chi2_region3_sec4_pip", "DC_edge_chi2_region3_sec4_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec5_pip =
      new TH2F("DC_edge_chi2_region3_sec5_pip", "DC_edge_chi2_region3_sec5_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec6_pip =
      new TH2F("DC_edge_chi2_region3_sec6_pip", "DC_edge_chi2_region3_sec6_pip", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec1_pim =
      new TH2F("DC_edge_chi2_region1_sec1_pim", "DC_edge_chi2_region1_sec1_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec2_pim =
      new TH2F("DC_edge_chi2_region1_sec2_pim", "DC_edge_chi2_region1_sec2_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec3_pim =
      new TH2F("DC_edge_chi2_region1_sec3_pim", "DC_edge_chi2_region1_sec3_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec4_pim =
      new TH2F("DC_edge_chi2_region1_sec4_pim", "DC_edge_chi2_region1_sec4_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec5_pim =
      new TH2F("DC_edge_chi2_region1_sec5_pim", "DC_edge_chi2_region1_sec5_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec6_pim =
      new TH2F("DC_edge_chi2_region1_sec6_pim", "DC_edge_chi2_region1_sec6_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec1_pim =
      new TH2F("DC_edge_chi2_region2_sec1_pim", "DC_edge_chi2_region2_sec1_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec2_pim =
      new TH2F("DC_edge_chi2_region2_sec2_pim", "DC_edge_chi2_region2_sec2_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec3_pim =
      new TH2F("DC_edge_chi2_region2_sec3_pim", "DC_edge_chi2_region2_sec3_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec4_pim =
      new TH2F("DC_edge_chi2_region2_sec4_pim", "DC_edge_chi2_region2_sec4_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec5_pim =
      new TH2F("DC_edge_chi2_region2_sec5_pim", "DC_edge_chi2_region2_sec5_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec6_pim =
      new TH2F("DC_edge_chi2_region2_sec6_pim", "DC_edge_chi2_region2_sec6_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec1_pim =
      new TH2F("DC_edge_chi2_region3_sec1_pim", "DC_edge_chi2_region3_sec1_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec2_pim =
      new TH2F("DC_edge_chi2_region3_sec2_pim", "DC_edge_chi2_region3_sec2_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec3_pim =
      new TH2F("DC_edge_chi2_region3_sec3_pim", "DC_edge_chi2_region3_sec3_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec4_pim =
      new TH2F("DC_edge_chi2_region3_sec4_pim", "DC_edge_chi2_region3_sec4_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec5_pim =
      new TH2F("DC_edge_chi2_region3_sec5_pim", "DC_edge_chi2_region3_sec5_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec6_pim =
      new TH2F("DC_edge_chi2_region3_sec6_pim", "DC_edge_chi2_region3_sec6_pim", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec1_Kp =
      new TH2F("DC_edge_chi2_region1_sec1_Kp", "DC_edge_chi2_region1_sec1_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec2_Kp =
      new TH2F("DC_edge_chi2_region1_sec2_Kp", "DC_edge_chi2_region1_sec2_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec3_Kp =
      new TH2F("DC_edge_chi2_region1_sec3_Kp", "DC_edge_chi2_region1_sec3_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec4_Kp =
      new TH2F("DC_edge_chi2_region1_sec4_Kp", "DC_edge_chi2_region1_sec4_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec5_Kp =
      new TH2F("DC_edge_chi2_region1_sec5_Kp", "DC_edge_chi2_region1_sec5_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec6_Kp =
      new TH2F("DC_edge_chi2_region1_sec6_Kp", "DC_edge_chi2_region1_sec6_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec1_Kp =
      new TH2F("DC_edge_chi2_region2_sec1_Kp", "DC_edge_chi2_region2_sec1_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec2_Kp =
      new TH2F("DC_edge_chi2_region2_sec2_Kp", "DC_edge_chi2_region2_sec2_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec3_Kp =
      new TH2F("DC_edge_chi2_region2_sec3_Kp", "DC_edge_chi2_region2_sec3_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec4_Kp =
      new TH2F("DC_edge_chi2_region2_sec4_Kp", "DC_edge_chi2_region2_sec4_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec5_Kp =
      new TH2F("DC_edge_chi2_region2_sec5_Kp", "DC_edge_chi2_region2_sec5_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec6_Kp =
      new TH2F("DC_edge_chi2_region2_sec6_Kp", "DC_edge_chi2_region2_sec6_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec1_Kp =
      new TH2F("DC_edge_chi2_region3_sec1_Kp", "DC_edge_chi2_region3_sec1_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec2_Kp =
      new TH2F("DC_edge_chi2_region3_sec2_Kp", "DC_edge_chi2_region3_sec2_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec3_Kp =
      new TH2F("DC_edge_chi2_region3_sec3_Kp", "DC_edge_chi2_region3_sec3_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec4_Kp =
      new TH2F("DC_edge_chi2_region3_sec4_Kp", "DC_edge_chi2_region3_sec4_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec5_Kp =
      new TH2F("DC_edge_chi2_region3_sec5_Kp", "DC_edge_chi2_region3_sec5_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec6_Kp =
      new TH2F("DC_edge_chi2_region3_sec6_Kp", "DC_edge_chi2_region3_sec6_Kp", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec1_Km =
      new TH2F("DC_edge_chi2_region1_sec1_Km", "DC_edge_chi2_region1_sec1_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec2_Km =
      new TH2F("DC_edge_chi2_region1_sec2_Km", "DC_edge_chi2_region1_sec2_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec3_Km =
      new TH2F("DC_edge_chi2_region1_sec3_Km", "DC_edge_chi2_region1_sec3_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec4_Km =
      new TH2F("DC_edge_chi2_region1_sec4_Km", "DC_edge_chi2_region1_sec4_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec5_Km =
      new TH2F("DC_edge_chi2_region1_sec5_Km", "DC_edge_chi2_region1_sec5_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region1_sec6_Km =
      new TH2F("DC_edge_chi2_region1_sec6_Km", "DC_edge_chi2_region1_sec6_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec1_Km =
      new TH2F("DC_edge_chi2_region2_sec1_Km", "DC_edge_chi2_region2_sec1_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec2_Km =
      new TH2F("DC_edge_chi2_region2_sec2_Km", "DC_edge_chi2_region2_sec2_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec3_Km =
      new TH2F("DC_edge_chi2_region2_sec3_Km", "DC_edge_chi2_region2_sec3_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec4_Km =
      new TH2F("DC_edge_chi2_region2_sec4_Km", "DC_edge_chi2_region2_sec4_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec5_Km =
      new TH2F("DC_edge_chi2_region2_sec5_Km", "DC_edge_chi2_region2_sec5_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region2_sec6_Km =
      new TH2F("DC_edge_chi2_region2_sec6_Km", "DC_edge_chi2_region2_sec6_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec1_Km =
      new TH2F("DC_edge_chi2_region3_sec1_Km", "DC_edge_chi2_region3_sec1_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec2_Km =
      new TH2F("DC_edge_chi2_region3_sec2_Km", "DC_edge_chi2_region3_sec2_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec3_Km =
      new TH2F("DC_edge_chi2_region3_sec3_Km", "DC_edge_chi2_region3_sec3_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec4_Km =
      new TH2F("DC_edge_chi2_region3_sec4_Km", "DC_edge_chi2_region3_sec4_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec5_Km =
      new TH2F("DC_edge_chi2_region3_sec5_Km", "DC_edge_chi2_region3_sec5_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_edge_chi2_region3_sec6_Km =
      new TH2F("DC_edge_chi2_region3_sec6_Km", "DC_edge_chi2_region3_sec6_Km", 300, 0, 30, 5000, 0, 500);
  ...
  hist_DC_hit_position_region2_cut5a =
      new TH2F("DC_hit_position_region2_cut_05a", "DC_hit_position_region2_cut_05a", 1000, -500, 500, 1000, -500, 500);
  ...
  hist_DC_hit_position_region2_hadron_cut_02a =
      new TH2F("DC_hit_position_region2_hadron_cut_02a", "DC_hit_position_region2_hadron_cut_02a", 1000, -450, 450,
               1000, -450, 450);
  ...
  hist_DC_hit_position_region2_hadron_cut_12a =
      new TH2F("DC_hit_position_region2_hadron_cut_12a", "DC_hit_position_region2_hadron_cut_12a", 1000, -450, 450,
               1000, -450, 450);
  ...
  hist_DC_hit_position_region2_hadron_cut_22a =
      new TH2F("DC_hit_position_region2_hadron_cut_22a", "DC_hit_position_region2_hadron_cut_22a", 1000, -450, 450,
               1000, -450, 450);
  ...
  hist_DC_hit_position_region2_hadron_cut_32a =
      new TH2F("DC_hit_position_region2_hadron_cut_32a", "DC_hit_position_region2_hadron_cut_32a", 1000, -450, 450,
               1000, -450, 450);
  ...
  hist_DC_hit_position_region2_hadron_cut_42a =
      new TH2F("DC_hit_position_region2_hadron_cut_42a", "DC_hit_position_region2_hadron_cut_42a", 1000, -450, 450,
               1000, -450, 450);
  ...
  hist_DC_hit_position_region2_hadron_cut_52a =
      new TH2F("DC_hit_position_region2_hadron_cut_52a", "DC_hit_position_region2_hadron_cut_52a", 1000, -450, 450,
               1000, -450, 450);
  ...
  hist_electron_sampfrac_vs_u_coord_vs_p_sec1 =
      new TH3F("hist_electron_sampfrac_vs_u_coord_vs_p_sec1", "electron E/p vs u coordinate vs p sector 1", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_u_coord_vs_p_sec2 =
      new TH3F("hist_electron_sampfrac_vs_u_coord_vs_p_sec2", "electron E/p vs u coordinate vs p sector 2", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_u_coord_vs_p_sec3 =
      new TH3F("hist_electron_sampfrac_vs_u_coord_vs_p_sec3", "electron E/p vs u coordinate vs p sector 3", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_u_coord_vs_p_sec4 =
      new TH3F("hist_electron_sampfrac_vs_u_coord_vs_p_sec4", "electron E/p vs u coordinate vs p sector 4", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_u_coord_vs_p_sec5 =
      new TH3F("hist_electron_sampfrac_vs_u_coord_vs_p_sec5", "electron E/p vs u coordinate vs p sector 5", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_u_coord_vs_p_sec6 =
      new TH3F("hist_electron_sampfrac_vs_u_coord_vs_p_sec6", "electron E/p vs u coordinate vs p sector 6", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_v_coord_vs_p_sec1 =
      new TH3F("hist_electron_sampfrac_vs_v_coord_vs_p_sec1", "electron E/p vs v coordinate vs p sector 1", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_v_coord_vs_p_sec2 =
      new TH3F("hist_electron_sampfrac_vs_v_coord_vs_p_sec2", "electron E/p vs v coordinate vs p sector 2", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_v_coord_vs_p_sec3 =
      new TH3F("hist_electron_sampfrac_vs_v_coord_vs_p_sec3", "electron E/p vs v coordinate vs p sector 3", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_v_coord_vs_p_sec4 =
      new TH3F("hist_electron_sampfrac_vs_v_coord_vs_p_sec4", "electron E/p vs v coordinate vs p sector 4", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_v_coord_vs_p_sec5 =
      new TH3F("hist_electron_sampfrac_vs_v_coord_vs_p_sec5", "electron E/p vs v coordinate vs p sector 5", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_v_coord_vs_p_sec6 =
      new TH3F("hist_electron_sampfrac_vs_v_coord_vs_p_sec6", "electron E/p vs v coordinate vs p sector 6", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_w_coord_vs_p_sec1 =
      new TH3F("hist_electron_sampfrac_vs_w_coord_vs_p_sec1", "electron E/p vs w coordinate vs p sector 1", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_w_coord_vs_p_sec2 =
      new TH3F("hist_electron_sampfrac_vs_w_coord_vs_p_sec2", "electron E/p vs w coordinate vs p sector 2", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_w_coord_vs_p_sec3 =
      new TH3F("hist_electron_sampfrac_vs_w_coord_vs_p_sec3", "electron E/p vs w coordinate vs p sector 3", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_w_coord_vs_p_sec4 =
      new TH3F("hist_electron_sampfrac_vs_w_coord_vs_p_sec4", "electron E/p vs w coordinate vs p sector 4", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_w_coord_vs_p_sec5 =
      new TH3F("hist_electron_sampfrac_vs_w_coord_vs_p_sec5", "electron E/p vs w coordinate vs p sector 5", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_w_coord_vs_p_sec6 =
      new TH3F("hist_electron_sampfrac_vs_w_coord_vs_p_sec6", "electron E/p vs w coordinate vs p sector 6", 450, 0, 450,
               50, 0, 0.5, 100, 0.0, Ebeam + 1);
  ...
  hist_electron_sampfrac_vs_u_coord_sec1 = new TH2F("hist_electron_sampfrac_vs_u_coord_sec1",
                                                    "electron E/p vs u coordinate sector 1", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_u_coord_sec2 = new TH2F("hist_electron_sampfrac_vs_u_coord_sec2",
                                                    "electron E/p vs u coordinate sector 2", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_u_coord_sec3 = new TH2F("hist_electron_sampfrac_vs_u_coord_sec3",
                                                    "electron E/p vs u coordinate sector 3", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_u_coord_sec4 = new TH2F("hist_electron_sampfrac_vs_u_coord_sec4",
                                                    "electron E/p vs u coordinate sector 4", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_u_coord_sec5 = new TH2F("hist_electron_sampfrac_vs_u_coord_sec5",
                                                    "electron E/p vs u coordinate sector 5", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_u_coord_sec6 = new TH2F("hist_electron_sampfrac_vs_u_coord_sec6",
                                                    "electron E/p vs u coordinate sector 6", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_u_coord =
      new TH2F("hist_electron_sampfrac_vs_u_coord", "electron E/p vs u coordinate", 900, 0, 450, 50, 0, 0.5);
  hist_electron_sampfrac_vs_u_coord->GetXaxis()->SetTitle("u /cm");
  hist_electron_sampfrac_vs_u_coord->GetYaxis()->SetTitle("E/p");

  hist_electron_sampfrac_vs_v_coord_sec1 = new TH2F("hist_electron_sampfrac_vs_v_coord_sec1",
                                                    "electron E/p vs v coordinate sector 1", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_v_coord_sec2 = new TH2F("hist_electron_sampfrac_vs_v_coord_sec2",
                                                    "electron E/p vs v coordinate sector 2", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_v_coord_sec3 = new TH2F("hist_electron_sampfrac_vs_v_coord_sec3",
                                                    "electron E/p vs v coordinate sector 3", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_v_coord_sec4 = new TH2F("hist_electron_sampfrac_vs_v_coord_sec4",
                                                    "electron E/p vs v coordinate sector 4", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_v_coord_sec5 = new TH2F("hist_electron_sampfrac_vs_v_coord_sec5",
                                                    "electron E/p vs v coordinate sector 5", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_v_coord_sec6 = new TH2F("hist_electron_sampfrac_vs_v_coord_sec6",
                                                    "electron E/p vs v coordinate sector 6", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_v_coord =
      new TH2F("hist_electron_sampfrac_vs_v_coord", "electron E/p vs v coordinate", 900, 0, 450, 50, 0, 0.5);
  hist_electron_sampfrac_vs_v_coord->GetXaxis()->SetTitle("v /cm");
  hist_electron_sampfrac_vs_v_coord->GetYaxis()->SetTitle("E/p");

  hist_electron_sampfrac_vs_w_coord_sec1 = new TH2F("hist_electron_sampfrac_vs_w_coord_sec1",
                                                    "electron E/p vs w coordinate sector 1", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_w_coord_sec2 = new TH2F("hist_electron_sampfrac_vs_w_coord_sec2",
                                                    "electron E/p vs w coordinate sector 2", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_w_coord_sec3 = new TH2F("hist_electron_sampfrac_vs_w_coord_sec3",
                                                    "electron E/p vs w coordinate sector 3", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_w_coord_sec4 = new TH2F("hist_electron_sampfrac_vs_w_coord_sec4",
                                                    "electron E/p vs w coordinate sector 4", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_w_coord_sec5 = new TH2F("hist_electron_sampfrac_vs_w_coord_sec5",
                                                    "electron E/p vs w coordinate sector 5", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_w_coord_sec6 = new TH2F("hist_electron_sampfrac_vs_w_coord_sec6",
                                                    "electron E/p vs w coordinate sector 6", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_electron_sampfrac_vs_w_coord =
      new TH2F("hist_electron_sampfrac_vs_w_coord", "electron E/p vs w coordinate", 900, 0, 450, 50, 0, 0.5);
  ...
  hist_DC_hit_position_region1_new_cut =
      new TH2F("DC_hit_position_region1_new_cut", "DC_hit_position_region1_new_cut", 1000, -450, 450, 1000, -450, 450);
  hist_DC_hit_position_region1_new_cut->GetXaxis()->SetTitle("x /cm");
  hist_DC_hit_position_region1_new_cut->GetYaxis()->SetTitle("y /cm");

  hist_DC_hit_position_region2_new_cut =
      new TH2F("DC_hit_position_region2_new_cut", "DC_hit_position_region2_new_cut", 1000, -500, 500, 1000, -500, 500);
  hist_DC_hit_position_region2_new_cut->GetXaxis()->SetTitle("x /cm");
  hist_DC_hit_position_region2_new_cut->GetYaxis()->SetTitle("y /cm");

  hist_DC_hit_position_region3_new_cut =
      new TH2F("DC_hit_position_region3_new_cut", "DC_hit_position_region3_new_cut", 1000, -500, 500, 1000, -500, 500);
  ...
  hist_HTCC_Nphe_vs_momentum =
      new TH2F("hist_HTCC_Nphe_vs_momentum", "HTCC Nphe vs momentum", 500, 0, Ebeam + 0.5, 200, 0, 200);
  hist_HTCC_Nphe_vs_momentum->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_sec1 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_sec1", "HTCC Nphe vs momentum sector 1", 500, 0, Ebeam + 0.5, 200, 0, 200);
  hist_HTCC_Nphe_vs_momentum_sec1->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_sec1->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_sec2 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_sec2", "HTCC Nphe vs momentum sector 2", 500, 0, Ebeam + 0.5, 200, 0, 200);
  hist_HTCC_Nphe_vs_momentum_sec2->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_sec2->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_sec3 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_sec3", "HTCC Nphe vs momentum sector 3", 500, 0, Ebeam + 0.5, 200, 0, 200);
  hist_HTCC_Nphe_vs_momentum_sec3->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_sec3->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_sec4 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_sec4", "HTCC Nphe vs momentum sector 4", 500, 0, Ebeam + 0.5, 200, 0, 200);
  hist_HTCC_Nphe_vs_momentum_sec4->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_sec4->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_sec5 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_sec5", "HTCC Nphe vs momentum sector 5", 500, 0, Ebeam + 0.5, 200, 0, 200);
  hist_HTCC_Nphe_vs_momentum_sec5->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_sec5->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_sec6 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_sec6", "HTCC Nphe vs momentum sector 6", 500, 0, Ebeam + 0.5, 200, 0, 200);
  hist_HTCC_Nphe_vs_momentum_sec6->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_sec6->GetYaxis()->SetTitle("Nphe");

  hist_HTCC_Nphe_vs_momentum_prot =
      new TH2F("hist_HTCC_Nphe_vs_momentum_prot", "HTCC Nphe vs momentum for protons", 500, 0, Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_prot->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_prot->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_prot_sec1 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_prot_sec1", "HTCC Nphe vs momentum for protons sector 1", 500, 0,
               Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_prot_sec1->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_prot_sec1->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_prot_sec2 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_prot_sec2", "HTCC Nphe vs momentum for protons sector 2", 500, 0,
               Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_prot_sec2->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_prot_sec2->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_prot_sec3 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_prot_sec3", "HTCC Nphe vs momentum for protons sector 3", 500, 0,
               Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_prot_sec3->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_prot_sec3->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_prot_sec4 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_prot_sec4", "HTCC Nphe vs momentum for protons sector 4", 500, 0,
               Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_prot_sec4->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_prot_sec4->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_prot_sec5 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_prot_sec5", "HTCC Nphe vs momentum for protons sector 5", 500, 0,
               Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_prot_sec5->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_prot_sec5->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_prot_sec6 =
      new TH2F("hist_HTCC_Nphe_vs_momentum_prot_sec6", "HTCC Nphe vs momentum for protons sector 6", 500, 0,
               Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_prot_sec6->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_prot_sec6->GetYaxis()->SetTitle("Nphe");

  hist_HTCC_Nphe_vs_momentum_pip =
      new TH2F("hist_HTCC_Nphe_vs_momentum_pip", "HTCC Nphe vs momentum for pip", 500, 0, Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_pip->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_pip->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_pip_sec1 = new TH2F(
      "hist_HTCC_Nphe_vs_momentum_pip_sec1", "HTCC Nphe vs momentum for pip sector 1", 500, 0, Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_pip_sec1->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_pip_sec1->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_pip_sec2 = new TH2F(
      "hist_HTCC_Nphe_vs_momentum_pip_sec2", "HTCC Nphe vs momentum for pip sector 2", 500, 0, Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_pip_sec2->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_pip_sec2->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_pip_sec3 = new TH2F(
      "hist_HTCC_Nphe_vs_momentum_pip_sec3", "HTCC Nphe vs momentum for pip sector 3", 500, 0, Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_pip_sec3->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_pip_sec3->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_pip_sec4 = new TH2F(
      "hist_HTCC_Nphe_vs_momentum_pip_sec4", "HTCC Nphe vs momentum for pip sector 4", 500, 0, Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_pip_sec4->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_pip_sec4->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_pip_sec5 = new TH2F(
      "hist_HTCC_Nphe_vs_momentum_pip_sec5", "HTCC Nphe vs momentum for pip sector 5", 500, 0, Ebeam - 0.5, 60, 0, 60);
  hist_HTCC_Nphe_vs_momentum_pip_sec5->GetXaxis()->SetTitle("p /GeV");
  hist_HTCC_Nphe_vs_momentum_pip_sec5->GetYaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_momentum_pip_sec6 = new TH2F(
      "hist_HTCC_Nphe_vs_momentum_pip_sec6", "HTCC Nphe vs momentum for pip sector 6", 500, 0, Ebeam - 0.5, 60, 0, 60);
  ...
  hist_HTCC_Nphe_vs_beta_sec1 =
      new TH2F("hist_HTCC_Nphe_vs_beta_sec1", "HTCC Nphe vs beta sector 1", 300, 0, 300, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_sec1->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_sec1->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_sec2 =
      new TH2F("hist_HTCC_Nphe_vs_beta_sec2", "HTCC Nphe vs beta sector 2", 300, 0, 300, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_sec2->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_sec2->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_sec3 =
      new TH2F("hist_HTCC_Nphe_vs_beta_sec3", "HTCC Nphe vs beta sector 3", 300, 0, 300, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_sec3->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_sec3->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_sec4 =
      new TH2F("hist_HTCC_Nphe_vs_beta_sec4", "HTCC Nphe vs beta sector 4", 300, 0, 300, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_sec4->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_sec4->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_sec5 =
      new TH2F("hist_HTCC_Nphe_vs_beta_sec5", "HTCC Nphe vs beta sector 5", 300, 0, 300, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_sec5->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_sec5->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_sec6 =
      new TH2F("hist_HTCC_Nphe_vs_beta_sec6", "HTCC Nphe vs beta sector 6", 300, 0, 300, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_sec6->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_sec6->GetYaxis()->SetTitle("#beta");

  hist_HTCC_Nphe_vs_beta_prot =
      new TH2F("hist_HTCC_Nphe_vs_beta_prot", "HTCC Nphe vs beta for protons", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_prot->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_prot->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_prot_sec1 =
      new TH2F("hist_HTCC_Nphe_vs_beta_prot_sec1", "HTCC Nphe vs beta for protons sector 1", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_prot_sec1->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_prot_sec1->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_prot_sec2 =
      new TH2F("hist_HTCC_Nphe_vs_beta_prot_sec2", "HTCC Nphe vs beta for protons sector 2", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_prot_sec2->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_prot_sec2->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_prot_sec3 =
      new TH2F("hist_HTCC_Nphe_vs_beta_prot_sec3", "HTCC Nphe vs beta for protons sector 3", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_prot_sec3->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_prot_sec3->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_prot_sec4 =
      new TH2F("hist_HTCC_Nphe_vs_beta_prot_sec4", "HTCC Nphe vs beta for protons sector 4", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_prot_sec4->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_prot_sec4->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_prot_sec5 =
      new TH2F("hist_HTCC_Nphe_vs_beta_prot_sec5", "HTCC Nphe vs beta for protons sector 5", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_prot_sec5->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_prot_sec5->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_prot_sec6 =
      new TH2F("hist_HTCC_Nphe_vs_beta_prot_sec6", "HTCC Nphe vs beta for protons sector 6", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_prot_sec6->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_prot_sec6->GetYaxis()->SetTitle("#beta");

  hist_HTCC_Nphe_vs_beta_pip =
      new TH2F("hist_HTCC_Nphe_vs_beta_pip", "HTCC Nphe vs beta for pip", 100, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_pip->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_pip->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_pip_sec1 =
      new TH2F("hist_HTCC_Nphe_vs_beta_pip_sec1", "HTCC Nphe vs beta for pip sector 1", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_pip_sec1->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_pip_sec1->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_pip_sec2 =
      new TH2F("hist_HTCC_Nphe_vs_beta_pip_sec2", "HTCC Nphe vs beta for pip sector 2", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_pip_sec2->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_pip_sec2->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_pip_sec3 =
      new TH2F("hist_HTCC_Nphe_vs_beta_pip_sec3", "HTCC Nphe vs beta for pip sector 3", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_pip_sec3->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_pip_sec3->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_pip_sec4 =
      new TH2F("hist_HTCC_Nphe_vs_beta_pip_sec4", "HTCC Nphe vs beta for pip sector 4", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_pip_sec4->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_pip_sec4->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_pip_sec5 =
      new TH2F("hist_HTCC_Nphe_vs_beta_pip_sec5", "HTCC Nphe vs beta for pip sector 5", 50, 0, 50, 700, 0.5, 1.2);
  hist_HTCC_Nphe_vs_beta_pip_sec5->GetXaxis()->SetTitle("Nphe");
  hist_HTCC_Nphe_vs_beta_pip_sec5->GetYaxis()->SetTitle("#beta");
  hist_HTCC_Nphe_vs_beta_pip_sec6 =
      new TH2F("hist_HTCC_Nphe_vs_beta_pip_sec6", "HTCC Nphe vs beta for pip sector 6", 50, 0, 50, 700, 0.5, 1.2);
  ...
  hist_CAL_Edep_electron =
      new TH1F("hist_CAL_Edep_electron", "Energy deposition of electrons in the complete Calorimeter", 500, 0, 2.5);
  hist_CAL_Edep_electron->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_CAL_Edep_electron->GetYaxis()->SetTitle("counts");
  hist_CAL_Edep_proton =
      new TH1F("hist_CAL_Edep_proton", "Energy deposition of protons in the complete Calorimeter", 500, 0, 1);
  hist_CAL_Edep_proton->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_CAL_Edep_proton->GetYaxis()->SetTitle("counts");
  hist_CAL_Edep_pip =
      new TH1F("hist_CAL_Edep_pip", "Energy deposition of pip in the complete Calorimeter", 600, 0, 1.5);
  hist_CAL_Edep_pip->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_CAL_Edep_pip->GetYaxis()->SetTitle("counts");
  hist_CAL_Edep_pim =
      new TH1F("hist_CAL_Edep_pim", "Energy deposition of pim in the complete Calorimeter", 600, 0, 1.5);
  hist_CAL_Edep_pim->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_CAL_Edep_pim->GetYaxis()->SetTitle("counts");
  hist_CAL_Edep_pip_diffsecele = new TH1F(
      "hist_CAL_Edep_pip_diffsecele",
      "Energy deposition of pip (in a different sector than electrons) in the complete Calorimeter", 600, 0, 1.5);
  hist_CAL_Edep_pip_diffsecele->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_CAL_Edep_pip_diffsecele->GetYaxis()->SetTitle("counts");
  hist_CAL_Edep_pim_diffsecele = new TH1F(
      "hist_CAL_Edep_pim_diffsecele",
      "Energy deposition of pim (in a different sector than electrons) in the complete Calorimeter", 600, 0, 1.5);
  ...
  hist_PCAL_Edep_pip_diffsecele =
      new TH1F("hist_PCAL_Edep_pip_diffsecele",
               "Energy deposition of pip (in a different sector than electrons) in PCAL", 500, 0, 1);
  hist_PCAL_Edep_pip_diffsecele->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_PCAL_Edep_pip_diffsecele->GetYaxis()->SetTitle("counts");
  hist_PCAL_Edep_pim_diffsecele =
      new TH1F("hist_PCAL_Edep_pim_diffsecele",
               "Energy deposition of pim (in a different sector than electrons) in PCAL", 500, 0, 1);
  ...
  hist_ECin_Edep_pip_diffsecele =
      new TH1F("hist_ECin_Edep_pip_diffsecele",
               "Energy deposition of pip (in a different sector than electrons) in ECin", 500, 0, 1);
  hist_ECin_Edep_pip_diffsecele->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_ECin_Edep_pip_diffsecele->GetYaxis()->SetTitle("counts");
  hist_ECin_Edep_pim_diffsecele =
      new TH1F("hist_ECin_Edep_pim_diffsecele",
               "Energy deposition of pim (in a different sector than electrons) in ECin", 500, 0, 1);
  ...
  hist_ECout_Edep_pip_diffsecele =
      new TH1F("hist_ECout_Edep_pip_diffsecele",
               "Energy deposition of pip (in a different sector than electrons) in ECout", 500, 0, 1);
  hist_ECout_Edep_pip_diffsecele->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_ECout_Edep_pip_diffsecele->GetYaxis()->SetTitle("counts");
  hist_ECout_Edep_pim_diffsecele =
      new TH1F("hist_ECout_Edep_pim_diffsecele",
               "Energy deposition of pim (in a different sector than electrons) in ECout", 500, 0, 1);
  ...
  hist_ECAL_Edep_pip_diffsecele =
      new TH1F("hist_ECAL_Edep_pip_diffsecele",
               "Energy deposition of pip (in a different sector than electrons) in ECAL", 500, 0, 1);
  hist_ECAL_Edep_pip_diffsecele->GetXaxis()->SetTitle("E_{dep} /GeV");
  hist_ECAL_Edep_pip_diffsecele->GetYaxis()->SetTitle("counts");
  hist_ECAL_Edep_pim_diffsecele =
      new TH1F("hist_ECAL_Edep_pim_diffsecele",
               "Energy deposition of pim (in a different sector than electrons) in ECAL", 500, 0, 1);
  ...
  hist_particles_p_vs_theta =
      new TH2F("hist_particles_p_vs_theta", "particles p vs #Theta", 560, 0, 140, 500, 0, Ebeam + 1);
  hist_particles_p_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_particles_p_vs_theta->GetYaxis()->SetTitle("p /GeV");
  hist_particles_p_vs_phi =
      new TH2F("hist_particles_p_vs_phi", "particles p vs #phi", 180, -180, 180, 500, 0, Ebeam + 1);
  hist_particles_p_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_particles_p_vs_phi->GetYaxis()->SetTitle("p /GeV");
  hist_particles_theta_vs_phi =
      new TH2F("hist_particles_theta_vs_phi", "particles #Theta vs #phi", 180, -180, 180, 560, 0, 140);
  ...
  hist_positives_p_vs_theta =
      new TH2F("hist_positives_p_vs_theta", "positives p vs #Theta", 560, 0, 140, 500, 0, Ebeam + 1);
  hist_positives_p_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_positives_p_vs_theta->GetYaxis()->SetTitle("p /GeV");
  hist_positives_p_vs_phi =
      new TH2F("hist_positives_p_vs_phi", "positives p vs #phi", 180, -180, 180, 500, 0, Ebeam + 1);
  hist_positives_p_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_positives_p_vs_phi->GetYaxis()->SetTitle("p /GeV");
  hist_positives_theta_vs_phi =
      new TH2F("hist_positives_theta_vs_phi", "positives #Theta vs #phi", 180, -180, 180, 560, 0, 140);
  ...
  hist_negatives_p_vs_theta =
      new TH2F("hist_negatives_p_vs_theta", "negatives p vs #Theta", 560, 0, 140, 500, 0, Ebeam + 1);
  hist_negatives_p_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_negatives_p_vs_theta->GetYaxis()->SetTitle("p /GeV");
  hist_negatives_p_vs_phi =
      new TH2F("hist_negatives_p_vs_phi", "negatives p vs #phi", 180, -180, 180, 500, 0, Ebeam + 1);
  hist_negatives_p_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_negatives_p_vs_phi->GetYaxis()->SetTitle("p /GeV");
  hist_negatives_theta_vs_phi =
      new TH2F("hist_negatives_theta_vs_phi", "negatives #Theta vs #phi", 180, -180, 180, 560, 0, 140);
  ...
  hist_all_electron_p_vs_theta =
      new TH2F("hist_all_electron_p_vs_theta", "electron p vs #Theta", 200, 0, 50, 500, 0, Ebeam + 1);
  hist_all_electron_p_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_all_electron_p_vs_theta->GetYaxis()->SetTitle("p /GeV");
  hist_all_electron_p_vs_phi =
      new TH2F("hist_all_electron_p_vs_phi", "electron p vs #phi", 180, -180, 180, 500, 0, Ebeam + 1);
  hist_all_electron_p_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_all_electron_p_vs_phi->GetYaxis()->SetTitle("p /GeV");
  hist_all_electron_theta_vs_phi =
      new TH2F("hist_all_electron_theta_vs_phi", "electron #Theta vs #phi", 180, -180, 180, 200, 0, 50);
  ...
  hist_all_proton_p_vs_theta =
      new TH2F("hist_all_proton_p_vs_theta", "proton p vs #Theta", 560, 0, 140, 500, 0, Ebeam + 1);
  hist_all_proton_p_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_all_proton_p_vs_theta->GetYaxis()->SetTitle("p /GeV");
  hist_all_proton_p_vs_phi =
      new TH2F("hist_all_proton_p_vs_phi", "proton p vs #phi", 180, -180, 180, 500, 0, Ebeam + 1);
  hist_all_proton_p_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_all_proton_p_vs_phi->GetYaxis()->SetTitle("p /GeV");
  hist_all_proton_theta_vs_phi =
      new TH2F("hist_all_proton_theta_vs_phi", "proton #Theta vs #phi", 180, -180, 180, 560, 0, 140);
  ...
  hist_all_neutron_p_vs_theta =
      new TH2F("hist_all_neutron_p_vs_theta", "neutron p vs #Theta", 560, 0, 140, 500, 0, Ebeam + 1);
  hist_all_neutron_p_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_all_neutron_p_vs_theta->GetYaxis()->SetTitle("p /GeV");
  hist_all_neutron_p_vs_phi =
      new TH2F("hist_all_neutron_p_vs_phi", "neutron p vs #phi", 180, -180, 180, 500, 0, Ebeam + 1);
  hist_all_neutron_p_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_all_neutron_p_vs_phi->GetYaxis()->SetTitle("p /GeV");
  hist_all_neutron_theta_vs_phi =
      new TH2F("hist_all_neutron_theta_vs_phi", "neutron #Theta vs #phi", 180, -180, 180, 560, 0, 140);
  ...
  hist_all_pip_theta_vs_phi =
      new TH2F("hist_all_pip_theta_vs_phi", "#pi^{+} #Theta vs #phi", 180, -180, 180, 560, 0, 140);
  ...
  hist_all_pim_theta_vs_phi =
      new TH2F("hist_all_pim_theta_vs_phi", "#pi^{-} #Theta vs #phi", 180, -180, 180, 560, 0, 140);
  ...
  hist_all_photon_p_vs_theta =
      new TH2F("hist_all_photon_p_vs_theta", "photon p vs #Theta", 200, 0, 50, 500, 0, Ebeam + 1);
  hist_all_photon_p_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_all_photon_p_vs_theta->GetYaxis()->SetTitle("p /GeV");
  hist_all_photon_p_vs_phi =
      new TH2F("hist_all_photon_p_vs_phi", "photon p vs #phi", 180, -180, 180, 500, 0, Ebeam + 1);
  hist_all_photon_p_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_all_photon_p_vs_phi->GetYaxis()->SetTitle("p /GeV");
  hist_all_photon_theta_vs_phi =
      new TH2F("hist_all_photon_theta_vs_phi", "photon #Theta vs #phi", 180, -180, 180, 200, 0, 50);
  ...
  hist_positive_vertex =
      new TH1F("hist_positive_vertex", "z vertex for particles with positive charge", 1000, -100, 100);
  hist_positive_vertex->GetXaxis()->SetTitle("v_{z} /cm");
  hist_positive_vertex->GetYaxis()->SetTitle("counts");
  hist_negative_vertex =
      new TH1F("hist_negative_vertex", "z vertex for particles with negative charge", 1000, -100, 100);
  ...
  hist_positive_vertex_vs_theta =
      new TH2F("hist_positive_vertex_vs_theta", "z vertex vs #Theta for particles with positive charge", 140, 0, 140,
               1000, -100, 100);
  hist_positive_vertex_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_positive_vertex_vs_theta->GetYaxis()->SetTitle("v_{z} /cm");
  hist_negative_vertex_vs_theta =
      new TH2F("hist_negative_vertex_vs_theta", "z vertex vs #Theta for particles with negative charge", 140, 0, 140,
               1000, -100, 100);
  hist_negative_vertex_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_negative_vertex_vs_theta->GetYaxis()->SetTitle("v_{z} /cm");
  hist_electron_vertex_vs_theta =
      new TH2F("hist_electron_vertex_vs_theta", "z vertex vs #Theta for electrons", 140, 0, 140, 1000, -100, 100);
  hist_electron_vertex_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_electron_vertex_vs_theta->GetYaxis()->SetTitle("v_{z} /cm");
  hist_proton_vertex_vs_theta =
      new TH2F("hist_proton_vertex_vs_theta", "z vertex vs #Theta for protons", 140, 0, 140, 1000, -100, 100);
  hist_proton_vertex_vs_theta->GetXaxis()->SetTitle("#Theta /deg");
  hist_proton_vertex_vs_theta->GetYaxis()->SetTitle("v_{z} /cm");

  hist_positive_vertex_vs_phi =
      new TH2F("hist_positive_vertex_vs_phi", "z vertex vs #phi for particles with positive charge", 140, 0, 140, 1000,
               -100, 100);
  hist_positive_vertex_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_positive_vertex_vs_phi->GetYaxis()->SetTitle("v_{z} /cm");
  hist_negative_vertex_vs_phi =
      new TH2F("hist_negative_vertex_vs_phi", "z vertex vs #phi for particles with negative charge", 140, 0, 140, 1000,
               -100, 100);
  hist_negative_vertex_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_negative_vertex_vs_phi->GetYaxis()->SetTitle("v_{z} /cm");
  hist_electron_vertex_vs_phi =
      new TH2F("hist_electron_vertex_vs_phi", "z vertex vs #phi for electrons", 140, 0, 140, 1000, -100, 100);
  hist_electron_vertex_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_electron_vertex_vs_phi->GetYaxis()->SetTitle("v_{z} /cm");
  hist_proton_vertex_vs_phi =
      new TH2F("hist_proton_vertex_vs_phi", "z vertex vs #phi for protons", 140, 0, 140, 1000, -100, 100);
  hist_proton_vertex_vs_phi->GetXaxis()->SetTitle("#phi /deg");
  hist_proton_vertex_vs_phi->GetYaxis()->SetTitle("v_{z} /cm");

  hist_positive_vertex_vs_p = new TH2F("hist_positive_vertex_vs_p", "z vertex vs #p for particles with positive charge",
                                       500, 0, Ebeam + 1, 1000, -100, 100);
  hist_positive_vertex_vs_p->GetXaxis()->SetTitle("#p /GeV");
  hist_positive_vertex_vs_p->GetYaxis()->SetTitle("v_{z} /cm");
  hist_negative_vertex_vs_p = new TH2F("hist_negative_vertex_vs_p", "z vertex vs #p for particles with negative charge",
                                       500, 0, Ebeam + 1, 1000, -100, 100);
  hist_negative_vertex_vs_p->GetXaxis()->SetTitle("#p /GeV");
  hist_negative_vertex_vs_p->GetYaxis()->SetTitle("v_{z} /cm");
  hist_electron_vertex_vs_p =
      new TH2F("hist_electron_vertex_vs_p", "z vertex vs #p for electrons", 500, 0, Ebeam + 1, 1000, -100, 100);
  hist_electron_vertex_vs_p->GetXaxis()->SetTitle("#p /GeV");
  hist_electron_vertex_vs_p->GetYaxis()->SetTitle("v_{z} /cm");
  hist_proton_vertex_vs_p =
      new TH2F("hist_proton_vertex_vs_p", "z vertex vs #p for protons", 500, 0, Ebeam + 1, 1000, -100, 100);
  ...
  hist_FTOF_phi_vs_sector_positives =
      new TH2F("FTOF_phi_vs_sector_positives", "#phi vs FTOF sector for particles with positive charge", 6, 0.5, 6.5,
               180, -180, 180);
  ...
  hist_FTOF_phi_vs_sector_negatives =
      new TH2F("FTOF_phi_vs_sector_negatives", "#phi vs FTOF sector for particles with negative charge", 6, 0.5, 6.5,
               180, -180, 180);
  ...
  hist_sampling_fraction_vs_E_sec1 =
      new TH2F("sampling_fraction_vs_E_sec1", "EC total sampling fraction versus E sec 1", 350, 0, 3.5, 300, 0, 0.6);
  hist_sampling_fraction_vs_E_sec1->GetXaxis()->SetTitle("E /GeV");
  hist_sampling_fraction_vs_E_sec1->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_E_sec2 =
      new TH2F("sampling_fraction_vs_E_sec2", "EC total sampling fraction versus E sec 2", 350, 0, 3.5, 300, 0, 0.6);
  hist_sampling_fraction_vs_E_sec2->GetXaxis()->SetTitle("E /GeV");
  hist_sampling_fraction_vs_E_sec2->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_E_sec3 =
      new TH2F("sampling_fraction_vs_E_sec3", "EC total sampling fraction versus E sec 3", 350, 0, 3.5, 300, 0, 0.6);
  hist_sampling_fraction_vs_E_sec3->GetXaxis()->SetTitle("E /GeV");
  hist_sampling_fraction_vs_E_sec3->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_E_sec4 =
      new TH2F("sampling_fraction_vs_E_sec4", "EC total sampling fraction versus E sec 4", 350, 0, 3.5, 300, 0, 0.6);
  hist_sampling_fraction_vs_E_sec4->GetXaxis()->SetTitle("E /GeV");
  hist_sampling_fraction_vs_E_sec4->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_E_sec5 =
      new TH2F("sampling_fraction_vs_E_sec5", "EC total sampling fraction versus E sec 5", 350, 0, 3.5, 300, 0, 0.6);
  hist_sampling_fraction_vs_E_sec5->GetXaxis()->SetTitle("E /GeV");
  hist_sampling_fraction_vs_E_sec5->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_E_sec6 =
      new TH2F("sampling_fraction_vs_E_sec6", "EC total sampling fraction versus E sec 6", 350, 0, 3.5, 300, 0, 0.6);
  hist_sampling_fraction_vs_E_sec6->GetXaxis()->SetTitle("E /GeV");
  hist_sampling_fraction_vs_E_sec6->GetYaxis()->SetTitle("E/p");

  hist_sampling_fraction_vs_p_sec1 =
      new TH2F("sampling_fraction_vs_p_sec1", "EC total sampling fraction versus p sec 1", 550, 0, 11, 300, 0, 0.6);
  hist_sampling_fraction_vs_p_sec1->GetXaxis()->SetTitle("p /GeV");
  hist_sampling_fraction_vs_p_sec1->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_p_sec2 =
      new TH2F("sampling_fraction_vs_p_sec2", "EC total sampling fraction versus p sec 2", 550, 0, 11, 300, 0, 0.6);
  hist_sampling_fraction_vs_p_sec2->GetXaxis()->SetTitle("p /GeV");
  hist_sampling_fraction_vs_p_sec2->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_p_sec3 =
      new TH2F("sampling_fraction_vs_p_sec3", "EC total sampling fraction versus p sec 3", 550, 0, 11, 300, 0, 0.6);
  hist_sampling_fraction_vs_p_sec3->GetXaxis()->SetTitle("p /GeV");
  hist_sampling_fraction_vs_p_sec3->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_p_sec4 =
      new TH2F("sampling_fraction_vs_p_sec4", "EC total sampling fraction versus p sec 4", 550, 0, 11, 300, 0, 0.6);
  hist_sampling_fraction_vs_p_sec4->GetXaxis()->SetTitle("p /GeV");
  hist_sampling_fraction_vs_p_sec4->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_p_sec5 =
      new TH2F("sampling_fraction_vs_p_sec5", "EC total sampling fraction versus p sec 5", 550, 0, 11, 300, 0, 0.6);
  hist_sampling_fraction_vs_p_sec5->GetXaxis()->SetTitle("p /GeV");
  hist_sampling_fraction_vs_p_sec5->GetYaxis()->SetTitle("E/p");
  hist_sampling_fraction_vs_p_sec6 =
      new TH2F("sampling_fraction_vs_p_sec6", "EC total sampling fraction versus p sec 6", 550, 0, 11, 300, 0, 0.6);
  ...
  while (c12.next() && ((process_Events != -1 && count < process_Events) || (process_Events == -1))) {
    ...
    std::vector<region_part_ptr> particles =
        c12.getDetParticles();  // particles is now a std::vector of particles for this event
    ...
    if (qa_check == true) {
      ...
      p4_ele_pcalw.clear();
      p4_phot_pcalw.clear();
      p4_ele_dcedge1.clear();
      p4_ele_dcedge2.clear();
      p4_ele_dcedge3.clear();
      p4_prot_dcedge1.clear();
      p4_prot_dcedge2.clear();
      p4_prot_dcedge3.clear();
      p4_pip_dcedge1.clear();
      p4_pip_dcedge2.clear();
      p4_pip_dcedge3.clear();
      p4_pim_dcedge1.clear();
      p4_pim_dcedge2.clear();
      p4_pim_dcedge3.clear();
      ele_det.clear();
      prot_det.clear();
      neutr_det.clear();
      pip_det.clear();
      ...
      if (e_count > 0) {
        ...
        for (Int_t i = 0; i < BUFFER; i++) {
          if (part_DC_Track_chi2[i] > 0) hist_FD_chi2->Fill(part_DC_Track_chi2[i]);
          if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_NDF->Fill(part_DC_Track_chi2[i] / part_DC_Track_NDF[i]);

          if (part_DC_sector[i] == 1) {
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_sec[0]->Fill(part_DC_Track_chi2[i]);
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_NDF_sec[0]->Fill(part_DC_Track_chi2[i] / part_DC_Track_NDF[i]);
          }
          if (part_DC_sector[i] == 2) {
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_sec[1]->Fill(part_DC_Track_chi2[i]);
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_NDF_sec[1]->Fill(part_DC_Track_chi2[i] / part_DC_Track_NDF[i]);
          }
          if (part_DC_sector[i] == 3) {
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_sec[2]->Fill(part_DC_Track_chi2[i]);
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_NDF_sec[2]->Fill(part_DC_Track_chi2[i] / part_DC_Track_NDF[i]);
          }
          if (part_DC_sector[i] == 4) {
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_sec[3]->Fill(part_DC_Track_chi2[i]);
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_NDF_sec[3]->Fill(part_DC_Track_chi2[i] / part_DC_Track_NDF[i]);
          }
          if (part_DC_sector[i] == 5) {
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_sec[4]->Fill(part_DC_Track_chi2[i]);
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_NDF_sec[4]->Fill(part_DC_Track_chi2[i] / part_DC_Track_NDF[i]);
          }
          if (part_DC_sector[i] == 6) {
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_sec[5]->Fill(part_DC_Track_chi2[i]);
            if (part_DC_Track_chi2[i] > 0) hist_FD_chi2_NDF_sec[5]->Fill(part_DC_Track_chi2[i] / part_DC_Track_NDF[i]);
          }
        }
        ...
        for (Int_t i = 0; i < BUFFER; i++) {
          ...
          if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 &&
              (FD_pimid_default_PID_check[i] && FD_pimid_beta_check[i]))
            hist_ECAL_Edep_pim->Fill(part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
          if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && FD_pipid_all_check[i] &&
              (e_FTOF_sec[i] != pip_FTOF_sec[i]))
            hist_ECAL_Edep_pip_diffsecele->Fill(part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
          if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 &&
              (FD_pimid_default_PID_check[i] && FD_pimid_beta_check[i]) && (e_FTOF_sec[i] != pim_FTOF_sec[i]))
      ...
      for (Int_t i = 0; i < BUFFER; i++) {
        ...
        if (fill_electron_pid_histograms) {
          ...
          if (FD_eid_charge_check[i]) {  // only particles which passed the default pid cut
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[0]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[0]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[0]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[0]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[0]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[0]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[0]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          if (FD_pipid_default_PID_check[i]) {
            if (part_Cal_PCAL_sector[i] == 1 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_pion_sec1->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
            }
            if (part_Cal_PCAL_sector[i] == 2 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_pion_sec2->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
            }
            if (part_Cal_PCAL_sector[i] == 3 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_pion_sec3->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
            }
            if (part_Cal_PCAL_sector[i] == 4 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_pion_sec4->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
            }
            if (part_Cal_PCAL_sector[i] == 5 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_pion_sec5->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
            }
            if (part_Cal_PCAL_sector[i] == 6 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_pion_sec6->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
            }
          }

          if (FD_eid_default_PID_check[i]) {
            double theta_PCAL = 180 / Pival *
                                acos(part_Cal_PCAL_z[i] / sqrt(pow(part_Cal_PCAL_x[i], 2) + pow(part_Cal_PCAL_y[i], 2) +
                                                               pow(part_Cal_PCAL_z[i], 2)));
            double phi_PCAL_raw =
                180 / Pival *
                atan2(part_Cal_PCAL_y[i] /
                          sqrt(pow(part_Cal_PCAL_x[i], 2) + pow(part_Cal_PCAL_y[i], 2) + pow(part_Cal_PCAL_z[i], 2)),
                      part_Cal_PCAL_x[i] /
                          sqrt(pow(part_Cal_PCAL_x[i], 2) + pow(part_Cal_PCAL_y[i], 2) + pow(part_Cal_PCAL_z[i], 2)));
            double phi_PCAL = 0;
            if (part_Cal_PCAL_sector[i] == 1) phi_PCAL = phi_PCAL_raw;
            if (part_Cal_PCAL_sector[i] == 2) phi_PCAL = phi_PCAL_raw - 60;
            if (part_Cal_PCAL_sector[i] == 3) phi_PCAL = phi_PCAL_raw - 120;
            if (part_Cal_PCAL_sector[i] == 4 && phi_PCAL_raw > 0) phi_PCAL = phi_PCAL_raw - 180;
            if (part_Cal_PCAL_sector[i] == 4 && phi_PCAL_raw < 0) phi_PCAL = phi_PCAL_raw + 180;
            if (part_Cal_PCAL_sector[i] == 5) phi_PCAL = phi_PCAL_raw + 120;
            if (part_Cal_PCAL_sector[i] == 6) phi_PCAL = phi_PCAL_raw + 60;
            ...
            if (part_Cal_PCAL_sector[i] == 1 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_sec1->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                             part_Cal_PCAL_energy[i] / part_p[i]);
              if (FD_eid_EC_sampling_fraction_check[i])
                hist_PCAL_vs_ECin_sampling_fraction_cut_sec1->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              if (part_p[i] > 2 && part_p[i] < 3) {
                hist_PCAL_vs_ECin_sampling_fraction_sec1_p23->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 3 && part_p[i] < 4) {
                hist_PCAL_vs_ECin_sampling_fraction_sec1_p34->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 4 && part_p[i] < 5) {
                hist_PCAL_vs_ECin_sampling_fraction_sec1_p45->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 5 && part_p[i] < 6) {
                hist_PCAL_vs_ECin_sampling_fraction_sec1_p56->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 6 && part_p[i] < 7) {
                hist_PCAL_vs_ECin_sampling_fraction_sec1_p67->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 7 && part_p[i] < 8) {
                hist_PCAL_vs_ECin_sampling_fraction_sec1_p78->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 8 && part_p[i] < 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec1_p89->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec1_p9->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
              }
            }
            if (part_Cal_PCAL_sector[i] == 2 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_sec2->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                             part_Cal_PCAL_energy[i] / part_p[i]);
              if (FD_eid_EC_sampling_fraction_check[i])
                hist_PCAL_vs_ECin_sampling_fraction_cut_sec2->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              if (part_p[i] > 2 && part_p[i] < 3) {
                hist_PCAL_vs_ECin_sampling_fraction_sec2_p23->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 3 && part_p[i] < 4) {
                hist_PCAL_vs_ECin_sampling_fraction_sec2_p34->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 4 && part_p[i] < 5) {
                hist_PCAL_vs_ECin_sampling_fraction_sec2_p45->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 5 && part_p[i] < 6) {
                hist_PCAL_vs_ECin_sampling_fraction_sec2_p56->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 6 && part_p[i] < 7) {
                hist_PCAL_vs_ECin_sampling_fraction_sec2_p67->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 7 && part_p[i] < 8) {
                hist_PCAL_vs_ECin_sampling_fraction_sec2_p78->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 8 && part_p[i] < 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec2_p89->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec2_p9->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
              }
            }
            if (part_Cal_PCAL_sector[i] == 3 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_sec3->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                             part_Cal_PCAL_energy[i] / part_p[i]);
              if (FD_eid_EC_sampling_fraction_check[i])
                hist_PCAL_vs_ECin_sampling_fraction_cut_sec3->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              if (part_p[i] > 2 && part_p[i] < 3) {
                hist_PCAL_vs_ECin_sampling_fraction_sec3_p23->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 3 && part_p[i] < 4) {
                hist_PCAL_vs_ECin_sampling_fraction_sec3_p34->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 4 && part_p[i] < 5) {
                hist_PCAL_vs_ECin_sampling_fraction_sec3_p45->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 5 && part_p[i] < 6) {
                hist_PCAL_vs_ECin_sampling_fraction_sec3_p56->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 6 && part_p[i] < 7) {
                hist_PCAL_vs_ECin_sampling_fraction_sec3_p67->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 7 && part_p[i] < 8) {
                hist_PCAL_vs_ECin_sampling_fraction_sec3_p78->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 8 && part_p[i] < 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec3_p89->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec3_p9->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
              }
            }
            if (part_Cal_PCAL_sector[i] == 4 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_sec4->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                             part_Cal_PCAL_energy[i] / part_p[i]);
              if (FD_eid_EC_sampling_fraction_check[i])
                hist_PCAL_vs_ECin_sampling_fraction_cut_sec4->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              if (part_p[i] > 2 && part_p[i] < 3) {
                hist_PCAL_vs_ECin_sampling_fraction_sec4_p23->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 3 && part_p[i] < 4) {
                hist_PCAL_vs_ECin_sampling_fraction_sec4_p34->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 4 && part_p[i] < 5) {
                hist_PCAL_vs_ECin_sampling_fraction_sec4_p45->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 5 && part_p[i] < 6) {
                hist_PCAL_vs_ECin_sampling_fraction_sec4_p56->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 6 && part_p[i] < 7) {
                hist_PCAL_vs_ECin_sampling_fraction_sec4_p67->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 7 && part_p[i] < 8) {
                hist_PCAL_vs_ECin_sampling_fraction_sec4_p78->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 8 && part_p[i] < 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec4_p89->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec4_p9->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
              }
            }
            if (part_Cal_PCAL_sector[i] == 5 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_sec5->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                             part_Cal_PCAL_energy[i] / part_p[i]);
              if (FD_eid_EC_sampling_fraction_check[i])
                hist_PCAL_vs_ECin_sampling_fraction_cut_sec5->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              if (part_p[i] > 2 && part_p[i] < 3) {
                hist_PCAL_vs_ECin_sampling_fraction_sec5_p23->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 3 && part_p[i] < 4) {
                hist_PCAL_vs_ECin_sampling_fraction_sec5_p34->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 4 && part_p[i] < 5) {
                hist_PCAL_vs_ECin_sampling_fraction_sec5_p45->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 5 && part_p[i] < 6) {
                hist_PCAL_vs_ECin_sampling_fraction_sec5_p56->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 6 && part_p[i] < 7) {
                hist_PCAL_vs_ECin_sampling_fraction_sec5_p67->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 7 && part_p[i] < 8) {
                hist_PCAL_vs_ECin_sampling_fraction_sec5_p78->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 8 && part_p[i] < 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec5_p89->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec5_p9->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
              }
            }
            if (part_Cal_PCAL_sector[i] == 6 && part_p[i] > 0 && part_Cal_ECin_energy[i] > 0) {
              hist_PCAL_vs_ECin_sampling_fraction_sec6->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                             part_Cal_PCAL_energy[i] / part_p[i]);
              if (FD_eid_EC_sampling_fraction_check[i])
                hist_PCAL_vs_ECin_sampling_fraction_cut_sec6->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              if (part_p[i] > 2 && part_p[i] < 3) {
                hist_PCAL_vs_ECin_sampling_fraction_sec6_p23->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 3 && part_p[i] < 4) {
                hist_PCAL_vs_ECin_sampling_fraction_sec6_p34->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 4 && part_p[i] < 5) {
                hist_PCAL_vs_ECin_sampling_fraction_sec6_p45->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 5 && part_p[i] < 6) {
                hist_PCAL_vs_ECin_sampling_fraction_sec6_p56->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 6 && part_p[i] < 7) {
                hist_PCAL_vs_ECin_sampling_fraction_sec6_p67->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 7 && part_p[i] < 8) {
                hist_PCAL_vs_ECin_sampling_fraction_sec6_p78->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 8 && part_p[i] < 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec6_p89->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                   part_Cal_PCAL_energy[i] / part_p[i]);
              }
              if (part_p[i] > 9) {
                hist_PCAL_vs_ECin_sampling_fraction_sec6_p9->Fill(part_Cal_ECin_energy[i] / part_p[i],
                                                                  part_Cal_PCAL_energy[i] / part_p[i]);
              }
            }
            ...
            double theta_DCr1 =
                180 / Pival *
                acos(part_DC_c1z[i] / sqrt(pow(part_DC_c1x[i], 2) + pow(part_DC_c1y[i], 2) + pow(part_DC_c1z[i], 2)));
            double phi_DCr1_raw =
                180 / Pival *
                atan2(part_DC_c1y[i] / sqrt(pow(part_DC_c1x[i], 2) + pow(part_DC_c1y[i], 2) + pow(part_DC_c1z[i], 2)),
                      part_DC_c1x[i] / sqrt(pow(part_DC_c1x[i], 2) + pow(part_DC_c1y[i], 2) + pow(part_DC_c1z[i], 2)));
            double phi_DCr1 = 0;
            if (part_DC_sector[i] == 1) phi_DCr1 = phi_DCr1_raw;
            if (part_DC_sector[i] == 2) phi_DCr1 = phi_DCr1_raw - 60;
            if (part_DC_sector[i] == 3) phi_DCr1 = phi_DCr1_raw - 120;
            if (part_DC_sector[i] == 4 && phi_DCr1_raw > 0) phi_DCr1 = phi_DCr1_raw - 180;
            if (part_DC_sector[i] == 4 && phi_DCr1_raw < 0) phi_DCr1 = phi_DCr1_raw + 180;
            if (part_DC_sector[i] == 5) phi_DCr1 = phi_DCr1_raw + 120;
            if (part_DC_sector[i] == 6) phi_DCr1 = phi_DCr1_raw + 60;
            ...
            for (Int_t j = 0; j < 30; j++) {
              if (theta_PCAL > j + 5 && theta_PCAL <= j + 6) {
                ...
                if (part_p[i] > 0) hist_DC_region1_electron_counts_vs_phi[j]->Fill(phi_DCr1);
              }
            }

            double theta_DCr2 =
                180 / Pival *
                acos(part_DC_c2z[i] / sqrt(pow(part_DC_c2x[i], 2) + pow(part_DC_c2y[i], 2) + pow(part_DC_c2z[i], 2)));
            double phi_DCr2_raw =
                180 / Pival *
                atan2(part_DC_c2y[i] / sqrt(pow(part_DC_c2x[i], 2) + pow(part_DC_c2y[i], 2) + pow(part_DC_c2z[i], 2)),
                      part_DC_c2x[i] / sqrt(pow(part_DC_c2x[i], 2) + pow(part_DC_c2y[i], 2) + pow(part_DC_c2z[i], 2)));
            double phi_DCr2 = 0;
            if (part_DC_sector[i] == 1) phi_DCr2 = phi_DCr2_raw;
            if (part_DC_sector[i] == 2) phi_DCr2 = phi_DCr2_raw - 60;
            if (part_DC_sector[i] == 3) phi_DCr2 = phi_DCr2_raw - 120;
            if (part_DC_sector[i] == 4 && phi_DCr2_raw > 0) phi_DCr2 = phi_DCr2_raw - 180;
            if (part_DC_sector[i] == 4 && phi_DCr2_raw < 0) phi_DCr2 = phi_DCr2_raw + 180;
            if (part_DC_sector[i] == 5) phi_DCr2 = phi_DCr2_raw + 120;
            if (part_DC_sector[i] == 6) phi_DCr2 = phi_DCr2_raw + 60;
            ...
            for (Int_t j = 0; j < 30; j++) {
              if (theta_PCAL > j + 5 && theta_PCAL <= j + 6) {
                ...
                if (part_p[i] > 0) hist_DC_region2_electron_counts_vs_phi[j]->Fill(phi_DCr2);
              }
            }

            double theta_DCr3 =
                180 / Pival *
                acos(part_DC_c3z[i] / sqrt(pow(part_DC_c3x[i], 2) + pow(part_DC_c3y[i], 2) + pow(part_DC_c3z[i], 2)));
            double phi_DCr3_raw =
                180 / Pival *
                atan2(part_DC_c3y[i] / sqrt(pow(part_DC_c3x[i], 2) + pow(part_DC_c3y[i], 2) + pow(part_DC_c3z[i], 2)),
                      part_DC_c3x[i] / sqrt(pow(part_DC_c3x[i], 2) + pow(part_DC_c3y[i], 2) + pow(part_DC_c3z[i], 2)));
            double phi_DCr3 = 0;
            if (part_DC_sector[i] == 1) phi_DCr3 = phi_DCr3_raw;
            if (part_DC_sector[i] == 2) phi_DCr3 = phi_DCr3_raw - 60;
            if (part_DC_sector[i] == 3) phi_DCr3 = phi_DCr3_raw - 120;
            if (part_DC_sector[i] == 4 && phi_DCr3_raw > 0) phi_DCr3 = phi_DCr3_raw - 180;
            if (part_DC_sector[i] == 4 && phi_DCr3_raw < 0) phi_DCr3 = phi_DCr3_raw + 180;
            if (part_DC_sector[i] == 5) phi_DCr3 = phi_DCr3_raw + 120;
            if (part_DC_sector[i] == 6) phi_DCr3 = phi_DCr3_raw + 60;
            ...
            for (Int_t j = 0; j < 30; j++) {
              if (theta_PCAL > j + 5 && theta_PCAL <= j + 6) {
                ...
                if (part_p[i] > 0) hist_DC_region3_electron_counts_vs_phi[j]->Fill(phi_DCr3);
              }
            }
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[1]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[1]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[1]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[1]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[1]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[1]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[1]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i]) {
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[2]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[2]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[2]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[2]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[2]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[2]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[2]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          // if(FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i] &&
          // FD_eid_DC_z_vertex_check[i] && FD_eid_DC_hit_position_region1_fiducial_check[i] &&
          // FD_eid_DC_hit_position_region2_fiducial_check[i] && FD_eid_DC_hit_position_region3_fiducial_check[i] &&
          // FD_eid_EC_hit_position_fiducial_check[i] && FD_eid_EC_sampling_fraction_check[i]){
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_sampling_fraction_check[i]) {
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[3]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[3]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[3]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[3]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[3]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[3]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[3]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_hit_position_fiducial_check[i]) {
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[4]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[4]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[4]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[4]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[4]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[4]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[4]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] &&
              FD_eid_DC_hit_position_region1_fiducial_check[i]) {
            if (part_p[i] > 0)
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[5]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[5]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[5]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[5]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[5]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[5]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[5]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] &&
              FD_eid_DC_hit_position_region2_fiducial_check[i]) {
            hist_DC_hit_position_region2_cut5a->Fill(part_DC_c2x[i], part_DC_c2y[i]);
          }

          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] &&
              FD_eid_DC_hit_position_region3_fiducial_check[i]) {
            if (part_p[i] > 0)
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[6]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[6]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[6]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[6]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[6]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[6]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[6]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_DC_z_vertex_check[i]) {
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[7]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[7]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[7]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[7]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[7]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[7]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[7]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i] &&
              ...
              FD_eid_DC_hit_position_region1_fiducial_check[i] && FD_eid_DC_hit_position_region3_fiducial_check[i] &&
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_sampling_fraction_check[i] &&
              FD_eid_EC_hit_position_fiducial_check[i] && FD_eid_DC_hit_position_region1_fiducial_check[i] &&
              FD_eid_DC_hit_position_region3_fiducial_check[i] && FD_eid_DC_z_vertex_check[i]) {
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[8]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i] &&
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[8]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[8]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[8]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[8]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[8]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[8]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          }

          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i] &&
              FD_eid_EC_sampling_fraction_check[i] && FD_eid_DC_hit_position_region1_fiducial_check[i] &&
              FD_eid_DC_hit_position_region3_fiducial_check[i] && FD_eid_DC_z_vertex_check[i]) {
            if (part_Cal_PCAL_x[i] != 0 && part_Cal_PCAL_y[i] != 0)
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i] &&
              FD_eid_EC_sampling_fraction_check[i] && FD_eid_EC_hit_position_fiducial_check[i] &&
              FD_eid_DC_hit_position_region3_fiducial_check[i] && FD_eid_DC_hit_position_region2_fiducial_check[i] &&
              FD_eid_DC_z_vertex_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
          ...
          if (FD_eid_default_PID_check[i] && FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i] &&
              FD_eid_EC_sampling_fraction_check[i] && FD_eid_EC_hit_position_fiducial_check[i] &&
              FD_eid_DC_hit_position_region1_fiducial_check[i] && FD_eid_DC_hit_position_region2_fiducial_check[i] &&
              FD_eid_DC_z_vertex_check[i]) {
            if (part_DC_c3x[i] != 0 && part_DC_c3y[i] != 0)
          ...
          if (FD_eid_all_check[i]) {
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[9]->Fill(part_Cal_PCAL_energy[i],
                                               part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[9]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[9]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[9]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[9]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[9]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[9]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
          ...
          if (FD_eid_default_PID_check[i] == false && FD_eid_charge_check[i] == true) {
            ...
            // EC
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL[10]->Fill(part_Cal_PCAL_energy[i],
                                                part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_ECin_energy[i] > 0 && part_Cal_ECout_energy[i] > 0)
            ...
            if (part_Cal_ECin_sector[i] == 1 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec1[10]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 2 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec2[10]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 3 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec3[10]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 4 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec4[10]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 5 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec5[10]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
            if (part_Cal_ECin_sector[i] == 6 && part_p[i] > 0)
              hist_EC_ECAL_sampling_fraction_sec6[10]->Fill(
                  part_p[i], (part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) / part_p[i]);
        ...
        if (fill_hadron_pid_histograms) {
          ...
          if (FD_protid_default_PID_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[0]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[0]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_protid_charge_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[1]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[1]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta[1]->Fill(part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (Getdvz(i) != 0) hist_delta_vz[1]->Fill(Getdvz(i));
          }
          if (FD_protid_default_PID_check[i] && FD_protid_charge_check[i] &&
              FD_protid_DC_hit_position_region1_fiducial_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[2]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[2]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_protid_default_PID_check[i] && FD_protid_charge_check[i] &&
              FD_protid_DC_hit_position_region2_fiducial_check[i]) {
          ...
          if (FD_protid_default_PID_check[i] && FD_protid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[3]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[3]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_protid_default_PID_check[i] && FD_protid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[4]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[4]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_protid_default_PID_check[i] && FD_protid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[5]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[5]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_protid_default_PID_check[i] && FD_protid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[6]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
          ...
          if (FD_protid_charge_check[i] && FD_protid_DC_hit_position_region1_fiducial_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[7]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[7]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_protid_default_PID_check[i] && FD_protid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[8]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[8]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_protid_all_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[9]->Fill(part_Cal_PCAL_energy[i],
                                                        part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[9]->Fill(part_p[i],
                                            part_p[i] / sqrt(part_p[i] * part_p[i] + m_p * m_p) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_neutrid_default_PID_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[10]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[10]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_neutrid_charge_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[11]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[11]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_neutrid_default_PID_check[i] && FD_neutrid_charge_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[12]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[12]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_neutrid_default_PID_check[i] && FD_neutrid_charge_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[13]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[13]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_neutrid_default_PID_check[i] && FD_neutrid_charge_check[i] && FD_neutrid_beta_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[14]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[14]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_neutrid_default_PID_check[i] && FD_neutrid_charge_check[i] && FD_neutrid_delta_beta_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[15]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[15]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_neutrid_default_PID_check[i] && FD_neutrid_charge_check[i] && FD_neutrid_tofmass_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[16]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[16]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_neutrid_default_PID_check[i] && FD_neutrid_charge_check[i] && FD_neutrid_delta_vz_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[18]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[18]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_neutrid_all_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[19]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_neutr > 0)
              hist_delta_beta_vs_p[19]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_n * m_n) - beta_neutr);
            if (part_p[i] > 0 && beta_neutr > 0)
          ...
          if (FD_pipid_default_PID_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[20]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[20]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_charge_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[21]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[21]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_default_PID_check[i] && FD_pipid_charge_check[i] &&
              FD_pipid_DC_hit_position_region1_fiducial_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[22]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[22]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_default_PID_check[i] && FD_pipid_charge_check[i] &&
              FD_pipid_DC_hit_position_region2_fiducial_check[i]) {
          ...
          if (FD_pipid_default_PID_check[i] && FD_pipid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[23]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[23]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_default_PID_check[i] && FD_pipid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[24]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[24]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_default_PID_check[i] && FD_pipid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[25]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[25]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_default_PID_check[i] && FD_pipid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[26]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[26]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_charge_check[i] && FD_pipid_DC_hit_position_region1_fiducial_check[i] &&
              FD_pipid_DC_hit_position_region2_fiducial_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[27]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[27]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_default_PID_check[i] && FD_pipid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[28]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[28]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pipid_all_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[29]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[29]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pip * m_pip) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_default_PID_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[30]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[30]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_charge_check[i] && FD_pimid_ele_reject_check[i] && FD_pimid_EC_outer_vs_EC_inner_check[i] &&
              FD_protid_DC_hit_position_region1_fiducial_check[i] &&
              FD_protid_DC_hit_position_region2_fiducial_check[i] &&
              FD_protid_DC_hit_position_region3_fiducial_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[31]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[31]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              FD_pimid_DC_hit_position_region1_fiducial_check[i] && FD_pimid_ele_reject_check[i] &&
              FD_pimid_EC_outer_vs_EC_inner_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[32]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[32]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              FD_pimid_DC_hit_position_region2_fiducial_check[i] && FD_pimid_ele_reject_check[i] &&
              FD_pimid_EC_outer_vs_EC_inner_check[i]) {
            hist_DC_hit_position_region2_hadron_cut_32a->Fill(part_DC_c2x[i], part_DC_c2y[i]);
          }
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_ele_reject_check[i] &&
              FD_pimid_EC_outer_vs_EC_inner_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[33]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[33]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              FD_pimid_DC_hit_position_region1_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_ele_reject_check[i] &&
              FD_pimid_EC_outer_vs_EC_inner_check[i] && FD_pimid_beta_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[34]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[34]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              ...
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_ele_reject_check[i] &&
              FD_pimid_EC_outer_vs_EC_inner_check[i] && FD_pimid_delta_beta_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[35]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[35]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              ...
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_ele_reject_check[i] &&
              FD_pimid_EC_outer_vs_EC_inner_check[i] && FD_pimid_tofmass_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[36]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[36]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_charge_check[i] && FD_pimid_DC_hit_position_region1_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_ele_reject_check[i] &&
              FD_pimid_EC_outer_vs_EC_inner_check[i] && FD_pipid_maximum_probability_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[37]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[37]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              ...
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_ele_reject_check[i] &&
              FD_pimid_EC_outer_vs_EC_inner_check[i] && FD_pimid_delta_vz_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[38]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[38]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_pimid_all_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[39]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[39]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_pim * m_pim) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_default_PID_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[40]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[40]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_charge_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[41]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[41]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
              FD_Kpid_DC_hit_position_region1_fiducial_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[42]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[42]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
              FD_Kpid_DC_hit_position_region2_fiducial_check[i]) {
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[43]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[43]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
              FD_Kpid_DC_hit_position_region1_fiducial_check[i] && FD_Kpid_DC_hit_position_region2_fiducial_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[44]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[44]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
              FD_Kpid_DC_hit_position_region1_fiducial_check[i] && FD_Kpid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kpid_DC_hit_position_region3_fiducial_check[i] && FD_Kpid_DC_hit_position_region1_fiducial_check[i] &&
              FD_Kpid_delta_beta_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[45]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[45]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[46]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[46]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[47]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[47]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[48]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[48]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kpid_all_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[49]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[49]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Kp * m_Kp) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[50]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[50]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] && FD_Kmid_ele_reject_check[i] &&
              FD_Kmid_EC_outer_vs_EC_inner_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[51]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[51]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_ele_reject_check[i] &&
              FD_Kmid_EC_outer_vs_EC_inner_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[52]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[52]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region2_fiducial_check[i] && FD_Kmid_ele_reject_check[i] &&
              FD_Kmid_EC_outer_vs_EC_inner_check[i]) {
            hist_DC_hit_position_region2_hadron_cut_52a->Fill(part_DC_c2x[i], part_DC_c2y[i]);
          }
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_ele_reject_check[i] &&
              FD_Kmid_EC_outer_vs_EC_inner_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[53]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[53]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_ele_reject_check[i] &&
              FD_Kmid_EC_outer_vs_EC_inner_check[i] && FD_Kmid_beta_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[54]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[54]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_ele_reject_check[i] &&
              FD_Kmid_EC_outer_vs_EC_inner_check[i] && FD_Kmid_delta_beta_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[55]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[55]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_ele_reject_check[i] &&
              FD_Kmid_EC_outer_vs_EC_inner_check[i] && FD_Kmid_tofmass_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[56]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[56]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_EC_outer_vs_EC_inner_check[i] &&
              FD_Kmid_maximum_probability_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[57]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[57]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_ele_reject_check[i] &&
              FD_Kmid_EC_outer_vs_EC_inner_check[i] && FD_Kmid_delta_vz_check[i]) {
            if (part_DC_c1x[i] != 0 && part_DC_c1y[i] != 0)
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[58]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[58]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (FD_Kmid_all_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_outer_vs_EC_inner_hadron[59]->Fill(part_Cal_PCAL_energy[i],
                                                         part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            ...
            if (part_p[i] > 0 && beta_charge > 0)
              hist_delta_beta_vs_p[59]->Fill(part_p[i],
                                             part_p[i] / sqrt(part_p[i] * part_p[i] + m_Km * m_Km) - beta_charge);
            if (part_p[i] > 0 && beta_charge > 0)
          ...
          if (CD_pimid_charge_check[i] && CD_pimid_beta_check[i] &&
              (beta_charge_central < 0.9999 || beta_charge_central > 1.0001)) {
          ...
          if (CD_pimid_charge_check[i] && CD_pipid_maximum_probability_check[i] &&
              (beta_charge_central < 0.9999 || beta_charge_central > 1.0001)) {
          ...
          if (CD_pimid_charge_check[i] && CD_pimid_delta_vz_check[i] &&
              (beta_charge_central < 0.9999 || beta_charge_central > 1.0001)) {
          ...
          if (CD_Kmid_charge_check[i] && CD_Kmid_beta_check[i] &&
              (beta_charge_central < 0.9999 || beta_charge_central > 1.0001)) {
          ...
          if (CD_Kmid_charge_check[i] && CD_Kmid_maximum_probability_check[i] &&
              (beta_charge_central < 0.9999 || beta_charge_central > 1.0001)) {
          ...
          if (CD_Kmid_charge_check[i] && CD_Kmid_delta_vz_check[i] &&
              (beta_charge_central < 0.9999 || beta_charge_central > 1.0001)) {
        ...
        if (fill_photon_pid_histograms) {
          if (FD_photid_default_PID_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL_phot[0]->Fill(part_Cal_PCAL_energy[i],
                                                    part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_PCAL_x[i] != 0 && part_Cal_PCAL_y[i] != 0)
          ...
          if (FD_photid_charge_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL_phot[1]->Fill(part_Cal_PCAL_energy[i],
                                                    part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_PCAL_x[i] != 0 && part_Cal_PCAL_y[i] != 0)
          ...
          if (FD_photid_default_PID_check[i] && FD_photid_charge_check[i] && FD_photid_beta_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL_phot[2]->Fill(part_Cal_PCAL_energy[i],
                                                    part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_PCAL_x[i] != 0 && part_Cal_PCAL_y[i] != 0)
              hist_EC_PCAL_hit_position_phot[2]->Fill(part_Cal_PCAL_x[i], part_Cal_PCAL_y[i]);
          }

          if (FD_photid_default_PID_check[i] && FD_photid_charge_check[i] &&
              FD_photid_EC_hit_position_fiducial_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL_phot[3]->Fill(part_Cal_PCAL_energy[i],
                                                    part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_PCAL_x[i] != 0 && part_Cal_PCAL_y[i] != 0)
          ...
          if (FD_photid_all_check[i]) {
            ...
            if ((part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]) > 0 && part_Cal_PCAL_energy[i] > 0)
              hist_EC_PCAL_vs_EC_ECAL_phot[4]->Fill(part_Cal_PCAL_energy[i],
                                                    part_Cal_ECin_energy[i] + part_Cal_ECout_energy[i]);
            if (part_Cal_PCAL_x[i] != 0 && part_Cal_PCAL_y[i] != 0)
        ...
        if (FD_photid_default_PID_check[i]) {
          if (part_Cal_PCAL_sector[i] == 1 && part_p[i] > 0) hist_photon_u_coord_sec1->Fill(part_Cal_PCAL_lu[i]);
          if (part_Cal_PCAL_sector[i] == 2 && part_p[i] > 0) hist_photon_u_coord_sec2->Fill(part_Cal_PCAL_lu[i]);
          if (part_Cal_PCAL_sector[i] == 3 && part_p[i] > 0) hist_photon_u_coord_sec3->Fill(part_Cal_PCAL_lu[i]);
          if (part_Cal_PCAL_sector[i] == 4 && part_p[i] > 0) hist_photon_u_coord_sec4->Fill(part_Cal_PCAL_lu[i]);
          if (part_Cal_PCAL_sector[i] == 5 && part_p[i] > 0) hist_photon_u_coord_sec5->Fill(part_Cal_PCAL_lu[i]);
          if (part_Cal_PCAL_sector[i] == 6 && part_p[i] > 0) hist_photon_u_coord_sec6->Fill(part_Cal_PCAL_lu[i]);
          if (part_p[i] > 0) hist_photon_u_coord->Fill(part_Cal_PCAL_lu[i]);

          if (part_Cal_PCAL_sector[i] == 1 && part_p[i] > 0) hist_photon_v_coord_sec1->Fill(part_Cal_PCAL_lv[i]);
          if (part_Cal_PCAL_sector[i] == 2 && part_p[i] > 0) hist_photon_v_coord_sec2->Fill(part_Cal_PCAL_lv[i]);
          if (part_Cal_PCAL_sector[i] == 3 && part_p[i] > 0) hist_photon_v_coord_sec3->Fill(part_Cal_PCAL_lv[i]);
          if (part_Cal_PCAL_sector[i] == 4 && part_p[i] > 0) hist_photon_v_coord_sec4->Fill(part_Cal_PCAL_lv[i]);
          if (part_Cal_PCAL_sector[i] == 5 && part_p[i] > 0) hist_photon_v_coord_sec5->Fill(part_Cal_PCAL_lv[i]);
          if (part_Cal_PCAL_sector[i] == 6 && part_p[i] > 0) hist_photon_v_coord_sec6->Fill(part_Cal_PCAL_lv[i]);
          if (part_p[i] > 0) hist_photon_v_coord->Fill(part_Cal_PCAL_lv[i]);

          if (part_Cal_PCAL_sector[i] == 1 && part_p[i] > 0) hist_photon_w_coord_sec1->Fill(part_Cal_PCAL_lw[i]);
          if (part_Cal_PCAL_sector[i] == 2 && part_p[i] > 0) hist_photon_w_coord_sec2->Fill(part_Cal_PCAL_lw[i]);
          if (part_Cal_PCAL_sector[i] == 3 && part_p[i] > 0) hist_photon_w_coord_sec3->Fill(part_Cal_PCAL_lw[i]);
          if (part_Cal_PCAL_sector[i] == 4 && part_p[i] > 0) hist_photon_w_coord_sec4->Fill(part_Cal_PCAL_lw[i]);
          if (part_Cal_PCAL_sector[i] == 5 && part_p[i] > 0) hist_photon_w_coord_sec5->Fill(part_Cal_PCAL_lw[i]);
          if (part_Cal_PCAL_sector[i] == 6 && part_p[i] > 0) hist_photon_w_coord_sec6->Fill(part_Cal_PCAL_lw[i]);
          if (part_p[i] > 0) hist_photon_w_coord->Fill(part_Cal_PCAL_lw[i]);
        }
        ...
        if (FD_eid_default_PID_check[i]) {
          ...
          if (part_Cal_PCAL_sector[i] == 1 && part_p[i] > 0)
            hist_electron_sampfrac_vs_u_coord_vs_p_sec1->Fill(part_Cal_PCAL_lu[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 2 && part_p[i] > 0)
            hist_electron_sampfrac_vs_u_coord_vs_p_sec2->Fill(part_Cal_PCAL_lu[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 3 && part_p[i] > 0)
            hist_electron_sampfrac_vs_u_coord_vs_p_sec3->Fill(part_Cal_PCAL_lu[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 4 && part_p[i] > 0)
            hist_electron_sampfrac_vs_u_coord_vs_p_sec4->Fill(part_Cal_PCAL_lu[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 5 && part_p[i] > 0)
            hist_electron_sampfrac_vs_u_coord_vs_p_sec5->Fill(part_Cal_PCAL_lu[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 6 && part_p[i] > 0)
            hist_electron_sampfrac_vs_u_coord_vs_p_sec6->Fill(part_Cal_PCAL_lu[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);

          if (part_Cal_PCAL_sector[i] == 1 && part_p[i] > 0)
            hist_electron_sampfrac_vs_v_coord_vs_p_sec1->Fill(part_Cal_PCAL_lv[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 2 && part_p[i] > 0)
            hist_electron_sampfrac_vs_v_coord_vs_p_sec2->Fill(part_Cal_PCAL_lv[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 3 && part_p[i] > 0)
            hist_electron_sampfrac_vs_v_coord_vs_p_sec3->Fill(part_Cal_PCAL_lv[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 4 && part_p[i] > 0)
            hist_electron_sampfrac_vs_v_coord_vs_p_sec4->Fill(part_Cal_PCAL_lv[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 5 && part_p[i] > 0)
            hist_electron_sampfrac_vs_v_coord_vs_p_sec5->Fill(part_Cal_PCAL_lv[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 6 && part_p[i] > 0)
            hist_electron_sampfrac_vs_v_coord_vs_p_sec6->Fill(part_Cal_PCAL_lv[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);

          if (part_Cal_PCAL_sector[i] == 1 && part_p[i] > 0)
            hist_electron_sampfrac_vs_w_coord_vs_p_sec1->Fill(part_Cal_PCAL_lw[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 2 && part_p[i] > 0)
            hist_electron_sampfrac_vs_w_coord_vs_p_sec2->Fill(part_Cal_PCAL_lw[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 3 && part_p[i] > 0)
            hist_electron_sampfrac_vs_w_coord_vs_p_sec3->Fill(part_Cal_PCAL_lw[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 4 && part_p[i] > 0)
            hist_electron_sampfrac_vs_w_coord_vs_p_sec4->Fill(part_Cal_PCAL_lw[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 5 && part_p[i] > 0)
            hist_electron_sampfrac_vs_w_coord_vs_p_sec5->Fill(part_Cal_PCAL_lw[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
          if (part_Cal_PCAL_sector[i] == 6 && part_p[i] > 0)
            hist_electron_sampfrac_vs_w_coord_vs_p_sec6->Fill(part_Cal_PCAL_lw[i], part_Cal_energy_total[i] / part_p[i],
                                                              part_p[i]);
        }
        ...
        if (FD_eid_charge_check[i] && FD_eid_EC_outer_vs_EC_inner_check[i] && FD_eid_DC_z_vertex_check[i] &&
            FD_eid_DC_hit_position_region1_fiducial_check[i] && FD_eid_DC_hit_position_region2_fiducial_check[i] &&
  ...
  if (show_FD_eid_statistics) {
    ...
    if (FD_eid_default_PID_pass != 0 && FD_eid_charge_pass != 0) {
      cout << "number of particles which passed default electron reference PID: " << FD_eid_default_PID_pass << "   ( "
           << 100 * FD_eid_default_PID_pass / FD_eid_charge_pass << " \% of neg. particles and "
           << 100 * FD_eid_default_PID_pass / FD_eid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed CC nphe cut (not in chain): " << FD_eid_CC_nphe_pass << "   ( "
           << 100 * FD_eid_CC_nphe_pass / FD_eid_charge_pass << " \% of neg. particles and "
           << 100 * FD_eid_CC_nphe_pass / FD_eid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed EC PCAL vs ECAL cut: " << FD_eid_EC_outer_vs_EC_inner_pass << "   ( "
           << 100 * FD_eid_EC_outer_vs_EC_inner_pass / FD_eid_charge_pass << " \% of neg. particles and "
           << 100 * FD_eid_EC_outer_vs_EC_inner_pass / FD_eid_default_PID_pass << " \% of reference PID particles)"
           << endl;
      cout << "number of particles which passed PCAL fiducial cut: " << FD_eid_EC_hit_position_fiducial_pass << "   ( "
           << 100 * FD_eid_EC_hit_position_fiducial_pass / FD_eid_charge_pass << " \% of neg. particles and "
           << 100 * FD_eid_EC_hit_position_fiducial_pass / FD_eid_default_PID_pass << " \% of reference PID particles)"
           << endl;
      cout << "number of particles which passed EC sampling fraction cut: " << FD_eid_EC_sampling_fraction_pass
           << "   ( " << 100 * FD_eid_EC_sampling_fraction_pass / FD_eid_charge_pass << " \% of neg. particles and "
           << 100 * FD_eid_EC_sampling_fraction_pass / FD_eid_default_PID_pass << " \% of reference PID particles)"
           << endl;
      cout << "number of particles which passed DC region 1 fid. cut: " << FD_eid_DC_hit_position_region1_fiducial_pass
           << "   ( " << 100 * FD_eid_DC_hit_position_region1_fiducial_pass / FD_eid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_eid_DC_hit_position_region1_fiducial_pass / FD_eid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 2 fid. cut: " << FD_eid_DC_hit_position_region2_fiducial_pass
           << "   ( " << 100 * FD_eid_DC_hit_position_region2_fiducial_pass / FD_eid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_eid_DC_hit_position_region2_fiducial_pass / FD_eid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 3 fid. cut: " << FD_eid_DC_hit_position_region3_fiducial_pass
           << "   ( " << 100 * FD_eid_DC_hit_position_region3_fiducial_pass / FD_eid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_eid_DC_hit_position_region3_fiducial_pass / FD_eid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed z vertex cut: " << FD_eid_DC_z_vertex_pass << "   ( "
           << 100 * FD_eid_DC_z_vertex_pass / FD_eid_charge_pass << " \% of neg. particles and "
           << 100 * FD_eid_DC_z_vertex_pass / FD_eid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "________________________________________________________________________________________________________"
              "__________________________________________________"
           << endl;
      cout << "number of particles which passed all FD_eid cuts: " << FD_eid_all_pass << "   ( "
           << 100 * FD_eid_all_pass / FD_eid_charge_pass << " \% of neg. particles and "
           << 100 * FD_eid_all_pass / FD_eid_default_PID_pass << " \% of reference PID particles)" << endl;
    } else
  ...
  if (show_charged_ID_statistics) {
    ...
    if (FD_protid_default_PID_pass != 0 && FD_protid_charge_pass != 0) {
      cout << "number of particles which passed default proton reference PID: " << FD_protid_default_PID_pass << "   ( "
           << 100 * FD_protid_default_PID_pass / FD_protid_charge_pass << " \% of pos. particles and "
           << 100 * FD_protid_default_PID_pass / FD_protid_default_PID_pass << " \% of reference PID particles)"
           << endl;
      cout << "number of particles which passed DC region 1 fid. cut: "
           << FD_protid_DC_hit_position_region1_fiducial_pass << "   ( "
           << 100 * FD_protid_DC_hit_position_region1_fiducial_pass / FD_protid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_protid_DC_hit_position_region1_fiducial_pass / FD_protid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 2 fid. cut: "
           << FD_protid_DC_hit_position_region2_fiducial_pass << "   ( "
           << 100 * FD_protid_DC_hit_position_region2_fiducial_pass / FD_protid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_protid_DC_hit_position_region2_fiducial_pass / FD_protid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 3 fid. cut: "
           << FD_protid_DC_hit_position_region3_fiducial_pass << "   ( "
           << 100 * FD_protid_DC_hit_position_region3_fiducial_pass / FD_protid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_protid_DC_hit_position_region3_fiducial_pass / FD_protid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed delta vz cut: " << FD_protid_delta_vz_pass << "   ( "
           << 100 * FD_protid_delta_vz_pass / FD_protid_charge_pass << " \% of pos. particles and "
           << 100 * FD_protid_delta_vz_pass / FD_protid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "________________________________________________________________________________________________________"
              "__________________________________________________"
           << endl;
      cout << "number of particles which passed all proton ID cuts: " << FD_protid_all_pass << "   ( "
           << 100 * FD_protid_all_pass / FD_protid_charge_pass << " \% of pos. particles and "
           << 100 * FD_protid_all_pass / FD_protid_default_PID_pass << " \% of reference PID particles)" << endl;
    } else
      cout << "No protons detected!" << endl;
    cout << endl;
    cout << "b) Neutron " << endl;
    if (FD_neutrid_default_PID_pass != 0 && FD_neutrid_charge_pass != 0) {
      cout << "number of particles which passed default neutron reference PID: " << FD_neutrid_default_PID_pass
           << "   ( " << 100 * FD_neutrid_default_PID_pass / FD_neutrid_charge_pass << " \% of neutral particles and "
           << 100 * FD_neutrid_default_PID_pass / FD_neutrid_default_PID_pass << " \% of reference PID particles)"
           << endl;
      cout << "number of particles which passed beta cut: " << FD_neutrid_beta_pass << "   ( "
           << 100 * FD_neutrid_beta_pass / FD_neutrid_charge_pass << " \% of neutral particles and "
           << 100 * FD_neutrid_beta_pass / FD_neutrid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed delta beta cut: " << FD_neutrid_delta_beta_pass << "   ( "
           << 100 * FD_neutrid_delta_beta_pass / FD_neutrid_charge_pass << " \% of neutral particles and "
           << 100 * FD_neutrid_delta_beta_pass / FD_neutrid_default_PID_pass << " \% of reference PID particles)"
           << endl;
      cout << "number of particles which passed tofmass cut: " << FD_neutrid_tofmass_pass << "   ( "
           << 100 * FD_neutrid_tofmass_pass / FD_neutrid_charge_pass << " \% of neutral particles and "
           << 100 * FD_neutrid_tofmass_pass / FD_neutrid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed delta vz cut: " << FD_neutrid_delta_vz_pass << "   ( "
           << 100 * FD_neutrid_delta_vz_pass / FD_neutrid_charge_pass << " \% of neutral particles and "
           << 100 * FD_neutrid_delta_vz_pass / FD_neutrid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "________________________________________________________________________________________________________"
              "__________________________________________________"
           << endl;
      cout << "number of particles which passed all neutron ID cuts: " << FD_neutrid_all_pass << "   ( "
           << 100 * FD_neutrid_all_pass / FD_neutrid_charge_pass << " \% of neutral particles and "
           << 100 * FD_neutrid_all_pass / FD_neutrid_default_PID_pass << " \% of reference PID particles)" << endl;
    } else
      cout << "No neutrons detected!" << endl;
    cout << endl;
    cout << "b) Pip " << endl;
    if (FD_pipid_default_PID_pass != 0 && FD_pipid_charge_pass != 0) {
      cout << "number of particles which passed default pip reference PID: " << FD_pipid_default_PID_pass << "   ( "
           << 100 * FD_pipid_default_PID_pass / FD_pipid_charge_pass << " \% of pos. particles and "
           << 100 * FD_pipid_default_PID_pass / FD_pipid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 1 fid. cut: "
           << FD_pipid_DC_hit_position_region1_fiducial_pass << "   ( "
           << 100 * FD_pipid_DC_hit_position_region1_fiducial_pass / FD_pipid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_pipid_DC_hit_position_region1_fiducial_pass / FD_pipid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 2 fid. cut: "
           << FD_pipid_DC_hit_position_region2_fiducial_pass << "   ( "
           << 100 * FD_pipid_DC_hit_position_region2_fiducial_pass / FD_pipid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_pipid_DC_hit_position_region2_fiducial_pass / FD_pipid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 3 fid. cut: "
           << FD_pipid_DC_hit_position_region3_fiducial_pass << "   ( "
           << 100 * FD_pipid_DC_hit_position_region3_fiducial_pass / FD_pipid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_pipid_DC_hit_position_region3_fiducial_pass / FD_pipid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed delta vz cut: " << FD_pipid_delta_vz_pass << "   ( "
           << 100 * FD_pipid_delta_vz_pass / FD_pipid_charge_pass << " \% of pos. particles and "
           << 100 * FD_pipid_delta_vz_pass / FD_pipid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "________________________________________________________________________________________________________"
              "__________________________________________________"
           << endl;
      cout << "number of particles which passed all positive pipon ID cuts: " << FD_pipid_all_pass << "   ( "
           << 100 * FD_pipid_all_pass / FD_pipid_charge_pass << " \% of pos. particles and "
           << 100 * FD_pipid_all_pass / FD_pipid_default_PID_pass << " \% of reference PID particles)" << endl;
    } else
      cout << "No pi plus detected!" << endl;
    cout << endl;
    cout << "c) Pim " << endl;
    if (FD_pimid_default_PID_pass != 0 && FD_pimid_charge_pass != 0) {
      cout << "number of particles which passed default pim reference PID: " << FD_pimid_default_PID_pass << "   ( "
           << 100 * FD_pimid_default_PID_pass / FD_pimid_charge_pass << " \% of neg. particles and "
           << 100 * FD_pimid_default_PID_pass / FD_pimid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 1 fid. cut: "
           << FD_pimid_DC_hit_position_region1_fiducial_pass << "   ( "
           << 100 * FD_pimid_DC_hit_position_region1_fiducial_pass / FD_pimid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_pimid_DC_hit_position_region1_fiducial_pass / FD_pimid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 2 fid. cut: "
           << FD_pimid_DC_hit_position_region2_fiducial_pass << "   ( "
           << 100 * FD_pimid_DC_hit_position_region2_fiducial_pass / FD_pimid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_pimid_DC_hit_position_region2_fiducial_pass / FD_pimid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 3 fid. cut: "
           << FD_pimid_DC_hit_position_region3_fiducial_pass << "   ( "
           << 100 * FD_pimid_DC_hit_position_region3_fiducial_pass / FD_pimid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_pimid_DC_hit_position_region3_fiducial_pass / FD_pimid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed delta vz cut: " << FD_pimid_delta_vz_pass << "   ( "
           << 100 * FD_pimid_delta_vz_pass / FD_pimid_charge_pass << " \% of neg. particles and "
           << 100 * FD_pimid_delta_vz_pass / FD_pimid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "________________________________________________________________________________________________________"
              "__________________________________________________"
           << endl;
      cout << "number of particles which passed all negative pion ID cuts: " << FD_pimid_all_pass << "   ( "
           << 100 * FD_pimid_all_pass / FD_pimid_charge_pass << " \% of neg. particles and "
           << 100 * FD_pimid_all_pass / FD_pimid_default_PID_pass << " \% of reference PID particles)" << endl;
    } else
      cout << "No pi minus detected!" << endl;
    cout << endl;
    cout << "d) Kp " << endl;
    if (FD_Kpid_default_PID_pass != 0 && FD_Kpid_charge_pass != 0) {
      cout << "number of particles which passed default Kp reference PID: " << FD_Kpid_default_PID_pass << "   ( "
           << 100 * FD_Kpid_default_PID_pass / FD_Kpid_charge_pass << " \% of pos. particles and "
           << 100 * FD_Kpid_default_PID_pass / FD_Kpid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 1 fid. cut: " << FD_Kpid_DC_hit_position_region1_fiducial_pass
           << "   ( " << 100 * FD_Kpid_DC_hit_position_region1_fiducial_pass / FD_Kpid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_Kpid_DC_hit_position_region1_fiducial_pass / FD_Kpid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 2 fid. cut: " << FD_Kpid_DC_hit_position_region2_fiducial_pass
           << "   ( " << 100 * FD_Kpid_DC_hit_position_region2_fiducial_pass / FD_Kpid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_Kpid_DC_hit_position_region2_fiducial_pass / FD_Kpid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 3 fid. cut: " << FD_Kpid_DC_hit_position_region3_fiducial_pass
           << "   ( " << 100 * FD_Kpid_DC_hit_position_region3_fiducial_pass / FD_Kpid_charge_pass
           << " \% of pos. particles and "
           << 100 * FD_Kpid_DC_hit_position_region3_fiducial_pass / FD_Kpid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed delta vz cut: " << FD_Kpid_delta_vz_pass << "   ( "
           << 100 * FD_Kpid_delta_vz_pass / FD_Kpid_charge_pass << " \% of pos. particles and "
           << 100 * FD_Kpid_delta_vz_pass / FD_Kpid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "________________________________________________________________________________________________________"
              "__________________________________________________"
           << endl;
      cout << "number of particles which passed all positive Kaon ID cuts: " << FD_Kpid_all_pass << "   ( "
           << 100 * FD_Kpid_all_pass / FD_Kpid_charge_pass << " \% of pos. particles and "
           << 100 * FD_Kpid_all_pass / FD_Kpid_default_PID_pass << " \% of reference PID particles)" << endl;
    } else
      cout << "No K plus detected!" << endl;
    cout << endl;
    cout << "e) Km " << endl;
    if (FD_Kmid_default_PID_pass != 0 && FD_Kmid_charge_pass != 0) {
      cout << "number of particles which passed default Km reference PID: " << FD_Kmid_default_PID_pass << "   ( "
           << 100 * FD_Kmid_default_PID_pass / FD_Kmid_charge_pass << " \% of neg. particles and "
           << 100 * FD_Kmid_default_PID_pass / FD_Kmid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 1 fid. cut: " << FD_Kmid_DC_hit_position_region1_fiducial_pass
           << "   ( " << 100 * FD_Kmid_DC_hit_position_region1_fiducial_pass / FD_Kmid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_Kmid_DC_hit_position_region1_fiducial_pass / FD_Kmid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 2 fid. cut: " << FD_Kmid_DC_hit_position_region2_fiducial_pass
           << "   ( " << 100 * FD_Kmid_DC_hit_position_region2_fiducial_pass / FD_Kmid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_Kmid_DC_hit_position_region2_fiducial_pass / FD_Kmid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed DC region 3 fid. cut: " << FD_Kmid_DC_hit_position_region3_fiducial_pass
           << "   ( " << 100 * FD_Kmid_DC_hit_position_region3_fiducial_pass / FD_Kmid_charge_pass
           << " \% of neg. particles and "
           << 100 * FD_Kmid_DC_hit_position_region3_fiducial_pass / FD_Kmid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed delta vz cut: " << FD_Kmid_delta_vz_pass << "   ( "
           << 100 * FD_Kmid_delta_vz_pass / FD_Kmid_charge_pass << " \% of neg. particles and "
           << 100 * FD_Kmid_delta_vz_pass / FD_Kmid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "________________________________________________________________________________________________________"
              "__________________________________________________"
           << endl;
      cout << "number of particles which passed all negative Kaon ID cuts: " << FD_Kmid_all_pass << "   ( "
           << 100 * FD_Kmid_all_pass / FD_Kmid_charge_pass << " \% of neg. particles and "
           << 100 * FD_Kmid_all_pass / FD_Kmid_default_PID_pass << " \% of reference PID particles)" << endl;
    } else
  ...
  if (show_photon_ID_statistics) {
    ...
    if (FD_photid_default_PID_pass != 0 && FD_photid_charge_pass != 0) {
      cout << "number of particles which passed default photon reference PID: " << FD_photid_default_PID_pass << "   ( "
           << 100 * FD_photid_default_PID_pass / FD_photid_charge_pass << " \% of neutral particles and "
           << 100 * FD_photid_default_PID_pass / FD_photid_default_PID_pass << " \% of reference PID particles)"
           << endl;
      cout << "number of particles which passed beta cut: " << FD_photid_beta_pass << "   ( "
           << 100 * FD_photid_beta_pass / FD_photid_charge_pass << " \% of neutral particles and "
           << 100 * FD_photid_beta_pass / FD_photid_default_PID_pass << " \% of reference PID particles)" << endl;
      cout << "number of particles which passed EC hit position fiducial cut: "
           << FD_photid_EC_hit_position_fiducial_pass << "   ( "
           << 100 * FD_photid_EC_hit_position_fiducial_pass / FD_photid_charge_pass << " \% of neutral particles and "
           << 100 * FD_photid_EC_hit_position_fiducial_pass / FD_photid_default_PID_pass
           << " \% of reference PID particles)" << endl;
      cout << "________________________________________________________________________________________________________"
              "__________________________________________________"
           << endl;
      cout << "number of particles which passed all photon cuts: " << FD_photid_all_pass << "   ( "
           << 100 * FD_photid_all_pass / FD_photid_charge_pass << " \% of neutral particles and "
           << 100 * FD_photid_all_pass / FD_photid_default_PID_pass << " \% of reference PID particles)" << endl;
    } else
...
void assign_particles(std::vector<region_part_ptr>& particles, mcpar_ptr mcparticles) {
  ...
  TRK_Nentries = Npart;
  Traj_Nentries = Npart;
  if (userich) RICHHadCher_Nentries = Npart;
  if (userich) RICHHadrons_Nentries = Npart;
...
void select_electron(int run) {
  ...
  for (Int_t i = 0; i < Npart; i++) {
    if (i < BUFFER) {
      ...
      if (abs(part_status[i]) >= 1000 && abs(part_status[i]) < 2000) {
        ...
        if (FT_eid_charge_check[i] && FT_eid_PID_check[i] && FT_eid_FTCAL_fiducial_check[i] &&
            FT_eid_FTTRK_fiducial_check[i] && FT_eid_FTHODO_fiducial_check[i] && FT_eid_energy_vs_radius_check[i]) {
          FT_eid_all_pass += 1;
      ...
      for (int k = 0; k < Npart; k++) {
        if (k < BUFFER) {
          if (use_own_PID_electron == true) {
            selector = (FD_eid_all_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (FT_eid_all_check[k] && abs(part_status[i]) >= 1000 && abs(part_status[i]) < 2000);
          } else {
            selector = (FD_eid_default_PID_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (FT_eid_PID_check[k] && abs(part_status[i]) >= 1000 && abs(part_status[i]) < 2000);
          }
          ...
          if (selector) {
            ...
            if (sqrt(part_px[k] * part_px[k] + part_py[k] * part_py[k] + part_pz[k] * part_pz[k]) > mom &&
                check != -1) {
  ...
  for (int i = 0; i < BUFFER; i++) {
    if (e_ind[i] != -1) {
      ...
      double p = sqrt(part_px[e_ind[i]] * part_px[e_ind[i]] + part_py[e_ind[i]] * part_py[e_ind[i]] +
                      part_pz[e_ind[i]] * part_pz[e_ind[i]]);
      ...
      if (abs(part_status[e_ind[i]]) >= 1000 && abs(part_status[e_ind[i]]) < 2000) ele_detect[i] = 1;
      if (abs(part_status[e_ind[i]]) >= 2000 && abs(part_status[e_ind[i]]) < 4000) ele_detect[i] = 2;
      ...
      if (part_Cal_PCAL_sector[e_ind[i]] == 1) ele_sector[i] = 1;
      if (part_Cal_PCAL_sector[e_ind[i]] == 2) ele_sector[i] = 2;
      if (part_Cal_PCAL_sector[e_ind[i]] == 3) ele_sector[i] = 3;
      if (part_Cal_PCAL_sector[e_ind[i]] == 4) ele_sector[i] = 4;
      if (part_Cal_PCAL_sector[e_ind[i]] == 5) ele_sector[i] = 5;
      if (part_Cal_PCAL_sector[e_ind[i]] == 6) ele_sector[i] = 6;
    }
  }
}
...
void select_proton(int run) {
  ...
  for (Int_t i = 0; i < Npart; i++) {
    if (i < BUFFER) {
      ...
      if (abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) {
        ...
        if (FD_protid_DC_hit_position_region1_fiducial_check[i] && FD_protid_charge_check[i] &&
            FD_protid_default_PID_check[i])
          FD_protid_DC_hit_position_region1_fiducial_pass += 1;
        if (FD_protid_DC_hit_position_region2_fiducial_check[i] && FD_protid_charge_check[i] &&
            FD_protid_default_PID_check[i])
          FD_protid_DC_hit_position_region2_fiducial_pass += 1;
        if (FD_protid_DC_hit_position_region3_fiducial_check[i] && FD_protid_charge_check[i] &&
            FD_protid_default_PID_check[i])
        ...
        if (cut_maximum_probability_charged == true) {
          ...
          if (FD_protid_default_PID_check[i] && FD_protid_charge_check[i] &&
              ...
              FD_protid_DC_hit_position_region2_fiducial_check[i] &&
              FD_protid_DC_hit_position_region3_fiducial_check[i] && FD_protid_beta_check[i] &&
              FD_protid_tofmass_check[i] && FD_protid_delta_beta_check[i] && FD_protid_delta_vz_check[i]) {
            FD_protid_all_pass += 1;
            FD_protid_all_check[i] = true;
          }
      ...
      if (i < BUFFER) {
        ...
        for (int k = 0; k < Npart; k++) {
          if (k < BUFFER) {
            selector = (FD_protid_all_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (CD_protid_all_check[k] && part_status[i] >= 4000);
  ...
  for (int i = 0; i < BUFFER; i++) {
    if (p_ind[i] != -1) {
      ...
      double p = sqrt(part_px[p_ind[i]] * part_px[p_ind[i]] + part_py[p_ind[i]] * part_py[p_ind[i]] +
                      part_pz[p_ind[i]] * part_pz[p_ind[i]]);
      ...
      if (abs(part_status[p_ind[i]]) >= 2000 && abs(part_status[p_ind[i]]) < 4000) prot_detect[i] = 2;
      ...
      if (part_DC_sector[p_ind[i]] == 1) prot_sector[i] = 1;
      if (part_DC_sector[p_ind[i]] == 2) prot_sector[i] = 2;
      if (part_DC_sector[p_ind[i]] == 3) prot_sector[i] = 3;
      if (part_DC_sector[p_ind[i]] == 4) prot_sector[i] = 4;
      if (part_DC_sector[p_ind[i]] == 5) prot_sector[i] = 5;
      if (part_DC_sector[p_ind[i]] == 6) prot_sector[i] = 6;
    }
  }
}
...
void select_neutron(int run) {
  ...
  for (Int_t i = 0; i < Npart; i++) {
    if (i < BUFFER) {
      ...
      if (abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) {
        ...
        // if(FD_neutrid_delta_beta_check[i] && FD_neutrid_charge_check[i] && FD_neutrid_default_PID_check[i])
        // FD_neutrid_delta_beta_pass += 1; if(FD_neutrid_tofmass_check[i] && FD_neutrid_charge_check[i] &&
        // FD_neutrid_default_PID_check[i]) 		FD_neutrid_tofmass_pass += 1;
        ...
        if (cut_extend_neutron == true) {
          if (part_p[i] > 0.05 && part_p[i] < 2.0 && FD_neutrid_default_PID_check[i] && FD_neutrid_charge_check[i] &&
              FD_neutrid_beta_check[i] && FD_neutrid_delta_vz_check[i]) {
          ...
          if (part_p[i] > 0.05 && FD_neutrid_default_PID_check[i] && FD_neutrid_charge_check[i] &&
              FD_neutrid_beta_check[i] && FD_neutrid_delta_vz_check[i]) {
            FD_neutrid_all_pass += 1;
            FD_neutrid_all_check[i] = true;
          }
      ...
      if (part_status[i] >= 4000) {
        ...
        if (part_p[i] > 0.03 && CD_neutrid_default_PID_check[i] && CD_neutrid_charge_check[i] &&
            CD_neutrid_beta_check[i] && CD_neutrid_delta_vz_check[i]) {
      ...
      if (i < BUFFER) {
        ...
        for (int k = 0; k < Npart; k++) {
          if (k < BUFFER) {
            selector = (FD_neutrid_all_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (CD_neutrid_all_check[k] && part_status[i] >= 4000);
  ...
  for (int i = 0; i < BUFFER; i++) {
    if (n_ind[i] != -1) {
      ...
      double p = sqrt(part_px[n_ind[i]] * part_px[n_ind[i]] + part_py[n_ind[i]] * part_py[n_ind[i]] +
                      part_pz[n_ind[i]] * part_pz[n_ind[i]]);
      ...
      if (abs(part_status[n_ind[i]]) >= 2000 && abs(part_status[n_ind[i]]) < 4000) neutr_detect[i] = 2;
      if (part_status[n_ind[i]] >= 4000) neutr_detect[i] = 3;
      if (part_Cal_PCAL_sector[n_ind[i]] == 1) neutr_sector[i] = 1;
      if (part_Cal_PCAL_sector[n_ind[i]] == 2) neutr_sector[i] = 2;
      if (part_Cal_PCAL_sector[n_ind[i]] == 3) neutr_sector[i] = 3;
      if (part_Cal_PCAL_sector[n_ind[i]] == 4) neutr_sector[i] = 4;
      if (part_Cal_PCAL_sector[n_ind[i]] == 5) neutr_sector[i] = 5;
      if (part_Cal_PCAL_sector[n_ind[i]] == 6) neutr_sector[i] = 6;
    }
  }
}
...
void select_pip(int run) {
  ...
  for (Int_t i = 0; i < Npart; i++) {
    if (i < BUFFER) {
      ...
      if (abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) {
        ...
        if (FD_pipid_DC_hit_position_region1_fiducial_check[i] && FD_pipid_charge_check[i] &&
            FD_pipid_default_PID_check[i])
          FD_pipid_DC_hit_position_region1_fiducial_pass += 1;
        if (FD_pipid_DC_hit_position_region2_fiducial_check[i] && FD_pipid_charge_check[i] &&
            FD_pipid_default_PID_check[i])
          FD_pipid_DC_hit_position_region2_fiducial_pass += 1;
        if (FD_pipid_DC_hit_position_region3_fiducial_check[i] && FD_pipid_charge_check[i] &&
            FD_pipid_default_PID_check[i])
        ...
        if (cut_maximum_probability_charged == true) {
          ...
          if (FD_pipid_default_PID_check[i] && FD_pipid_charge_check[i] &&
              ...
              FD_pipid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pipid_DC_hit_position_region3_fiducial_check[i] && FD_pipid_beta_check[i] &&
              FD_pipid_delta_beta_check[i] && FD_pipid_tofmass_check[i] && FD_pipid_delta_vz_check[i]) {
            FD_pipid_all_pass += 1;
            FD_pipid_all_check[i] = true;
          }
        } else if (use_fiducial_charged == true) {
      ...
      if (part_status[i] >= 4000) {
        ...
        if (CD_cut_maximum_probability_charged == true) {
          if (CD_pipid_default_PID_check[i] && CD_pipid_charge_check[i] && CD_pipid_maximum_probability_check[i] &&
              CD_pipid_delta_vz_check[i]) {
            CD_pipid_all_pass += 1;
            CD_pipid_all_check[i] = true;
          }
        } else if (CD_cut_beta_vs_p_charged == true) {
          if (CD_pipid_default_PID_check[i] && CD_pipid_charge_check[i] && CD_pipid_beta_check[i] &&
              CD_pipid_delta_vz_check[i]) {
            CD_pipid_all_pass += 1;
            CD_pipid_all_check[i] = true;
          }
      ...
      if (i < BUFFER) {
        ...
        for (int k = 0; k < Npart; k++) {
          if (k < BUFFER) {
            selector = (FD_pipid_all_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (CD_pipid_all_check[k] && part_status[i] >= 4000);
  ...
  for (int i = 0; i < BUFFER; i++) {
    if (pip_ind[i] != -1) {
      ...
      double p = sqrt(part_px[pip_ind[i]] * part_px[pip_ind[i]] + part_py[pip_ind[i]] * part_py[pip_ind[i]] +
                      part_pz[pip_ind[i]] * part_pz[pip_ind[i]]);
      ...
      if (abs(part_status[pip_ind[i]]) >= 2000 && abs(part_status[pip_ind[i]]) < 4000) pip_detect[i] = 2;
...
void select_pim(int run) {
  ...
  for (Int_t i = 0; i < Npart; i++) {
    if (i < BUFFER) {
      ...
      if (abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) {
        ...
        if (FD_pimid_DC_hit_position_region1_fiducial_check[i] && FD_pimid_charge_check[i] &&
            FD_pimid_default_PID_check[i])
          FD_pimid_DC_hit_position_region1_fiducial_pass += 1;
        if (FD_pimid_DC_hit_position_region2_fiducial_check[i] && FD_pimid_charge_check[i] &&
            FD_pimid_default_PID_check[i])
          FD_pimid_DC_hit_position_region2_fiducial_pass += 1;
        if (FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_charge_check[i] &&
            FD_pimid_default_PID_check[i])
        ...
        if (cut_maximum_probability_charged == true) {
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              FD_pimid_DC_hit_position_region1_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_maximum_probability_check[i] &&
              FD_pimid_delta_vz_check[i]) {
            FD_pimid_all_pass += 1;
          ...
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              FD_pimid_DC_hit_position_region1_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_beta_check[i] &&
              FD_pimid_delta_vz_check[i]) {
            FD_pimid_all_pass += 1;
            FD_pimid_all_check[i] = true;
          }
          ...
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              ...
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_beta_check[i] &&
              FD_pimid_delta_beta_check[i] && FD_pimid_tofmass_check[i] && FD_pimid_delta_vz_check[i]) {
            FD_pimid_all_pass += 1;
            FD_pimid_all_check[i] = true;
          }
        } else if (use_fiducial_charged == true) {
          if (FD_pimid_default_PID_check[i] && FD_pimid_charge_check[i] &&
              FD_pimid_DC_hit_position_region1_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region2_fiducial_check[i] &&
              FD_pimid_DC_hit_position_region3_fiducial_check[i] && FD_pimid_delta_vz_check[i]) {
            FD_pimid_all_pass += 1;
            FD_pimid_all_check[i] = true;
          }
        } else {
      ...
      if (part_status[i] >= 4000) {
        ...
        if (CD_cut_maximum_probability_charged == true) {
          if (CD_pimid_default_PID_check[i] && CD_pimid_charge_check[i] && CD_pimid_maximum_probability_check[i] &&
              CD_pimid_delta_vz_check[i]) {
            CD_pimid_all_pass += 1;
            CD_pimid_all_check[i] = true;
          }
        } else if (CD_cut_beta_vs_p_charged == true) {
          if (CD_pimid_default_PID_check[i] && CD_pimid_charge_check[i] && CD_pimid_beta_check[i] &&
              CD_pimid_delta_vz_check[i]) {
            CD_pimid_all_pass += 1;
            CD_pimid_all_check[i] = true;
          }
      ...
      if (i < BUFFER) {
        ...
        for (int k = 0; k < Npart; k++) {
          if (k < BUFFER) {
            selector = (FD_pimid_all_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (CD_pimid_all_check[k] && part_status[i] >= 4000);
  ...
  for (int i = 0; i < BUFFER; i++) {
    if (pim_ind[i] != -1) {
      ...
      double p = sqrt(part_px[pim_ind[i]] * part_px[pim_ind[i]] + part_py[pim_ind[i]] * part_py[pim_ind[i]] +
                      part_pz[pim_ind[i]] * part_pz[pim_ind[i]]);
      ...
      if (abs(part_status[pim_ind[i]]) >= 2000 && abs(part_status[pim_ind[i]]) < 4000) pim_detect[i] = 2;
      ...
      if (part_DC_sector[pim_ind[i]] == 1) pim_sector[i] = 1;
      if (part_DC_sector[pim_ind[i]] == 2) pim_sector[i] = 2;
      if (part_DC_sector[pim_ind[i]] == 3) pim_sector[i] = 3;
      if (part_DC_sector[pim_ind[i]] == 4) pim_sector[i] = 4;
      if (part_DC_sector[pim_ind[i]] == 5) pim_sector[i] = 5;
      if (part_DC_sector[pim_ind[i]] == 6) pim_sector[i] = 6;
...
void select_Kplus(int run) {
  ...
  for (Int_t i = 0; i < Npart; i++) {
    if (i < BUFFER) {
      ...
      if (abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000 && part_DC_sector[i] != 0) {
        ...
        if (FD_Kpid_DC_hit_position_region1_fiducial_check[i] && FD_Kpid_charge_check[i] &&
            FD_Kpid_default_PID_check[i])
          FD_Kpid_DC_hit_position_region1_fiducial_pass += 1;
        if (FD_Kpid_DC_hit_position_region2_fiducial_check[i] && FD_Kpid_charge_check[i] &&
            FD_Kpid_default_PID_check[i])
          FD_Kpid_DC_hit_position_region2_fiducial_pass += 1;
        if (FD_Kpid_DC_hit_position_region3_fiducial_check[i] && FD_Kpid_charge_check[i] &&
            FD_Kpid_default_PID_check[i])
        ...
        if (cut_maximum_probability_charged == true) {
          ...
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
              FD_Kpid_DC_hit_position_region1_fiducial_check[i] && FD_Kpid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kpid_DC_hit_position_region3_fiducial_check[i] && FD_Kpid_beta_check[i] && FD_Kpid_delta_vz_check[i]) {
            FD_Kpid_all_pass += 1;
            FD_Kpid_all_check[i] = true;
          }
        } else if (cut_beta_vs_p_charged == true && cut_deltabeta_charged == true && cut_tofmass_charged == true) {
          if (FD_Kpid_default_PID_check[i] && FD_Kpid_charge_check[i] &&
              FD_Kpid_DC_hit_position_region1_fiducial_check[i] && FD_Kpid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kpid_DC_hit_position_region3_fiducial_check[i] && FD_Kpid_beta_check[i] &&
              FD_Kpid_delta_beta_check[i] && FD_Kpid_tofmass_check[i] && FD_Kpid_delta_vz_check[i]) {
            FD_Kpid_all_pass += 1;
            FD_Kpid_all_check[i] = true;
          }
        } else if (use_fiducial_charged == true) {
      ...
      if (part_status[i] >= 4000) {
        ...
        if (CD_cut_maximum_probability_charged == true) {
          if (CD_Kpid_default_PID_check[i] && CD_Kpid_charge_check[i] && CD_Kpid_maximum_probability_check[i] &&
              CD_Kpid_delta_vz_check[i]) {
            CD_Kpid_all_pass += 1;
            CD_Kpid_all_check[i] = true;
          }
        } else if (CD_cut_beta_vs_p_charged == true) {
          if (CD_Kpid_default_PID_check[i] && CD_Kpid_charge_check[i] && CD_Kpid_beta_check[i] &&
              CD_Kpid_delta_vz_check[i]) {
            CD_Kpid_all_pass += 1;
            CD_Kpid_all_check[i] = true;
          }
      ...
      if (i < BUFFER) {
        ...
        for (int k = 0; k < Npart; k++) {
          if (k < BUFFER) {
            selector = (FD_Kpid_all_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (CD_Kpid_all_check[k] && part_status[i] >= 4000);
  ...
  for (int i = 0; i < BUFFER; i++) {
    if (Kp_ind[i] != -1) {
      ...
      double p = sqrt(part_px[Kp_ind[i]] * part_px[Kp_ind[i]] + part_py[Kp_ind[i]] * part_py[Kp_ind[i]] +
                      part_pz[Kp_ind[i]] * part_pz[Kp_ind[i]]);
      ...
      if (abs(part_status[Kp_ind[i]]) >= 2000 && abs(part_status[Kp_ind[i]]) < 4000) Kp_detect[i] = 2;
      if (part_status[Kp_ind[i]] >= 4000) Kp_detect[i] = 3;
      Kp_chi2pid[i] = part_chi2pid[Kp_ind[i]];
      if (part_DC_sector[Kp_ind[i]] == 1) Kp_sector[i] = 1;
      if (part_DC_sector[Kp_ind[i]] == 2) Kp_sector[i] = 2;
      if (part_DC_sector[Kp_ind[i]] == 3) Kp_sector[i] = 3;
      if (part_DC_sector[Kp_ind[i]] == 4) Kp_sector[i] = 4;
      if (part_DC_sector[Kp_ind[i]] == 5) Kp_sector[i] = 5;
      if (part_DC_sector[Kp_ind[i]] == 6) Kp_sector[i] = 6;
...
void select_Kminus(int run) {
  ...
  for (Int_t i = 0; i < Npart; i++) {
    if (i < BUFFER) {
      ...
      if (abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) {
        ...
        if (FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_charge_check[i] &&
            FD_Kmid_default_PID_check[i])
          FD_Kmid_DC_hit_position_region1_fiducial_pass += 1;
        if (FD_Kmid_DC_hit_position_region2_fiducial_check[i] && FD_Kmid_charge_check[i] &&
            FD_Kmid_default_PID_check[i])
          FD_Kmid_DC_hit_position_region2_fiducial_pass += 1;
        if (FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_charge_check[i] &&
            FD_Kmid_default_PID_check[i])
        ...
        if (cut_maximum_probability_charged == true) {
          ...
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_beta_check[i] && FD_Kmid_delta_vz_check[i]) {
            FD_Kmid_all_pass += 1;
            FD_Kmid_all_check[i] = true;
          }
        } else if (cut_beta_vs_p_charged == true && cut_deltabeta_charged == true && cut_tofmass_charged == true) {
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              ...
              FD_Kmid_delta_beta_check[i] && FD_Kmid_tofmass_check[i] && FD_Kmid_delta_vz_check[i]) {
            FD_Kmid_all_pass += 1;
            FD_Kmid_all_check[i] = true;
          }
        } else if (use_fiducial_charged == true) {
          if (FD_Kmid_default_PID_check[i] && FD_Kmid_charge_check[i] &&
              FD_Kmid_DC_hit_position_region1_fiducial_check[i] && FD_Kmid_DC_hit_position_region2_fiducial_check[i] &&
              FD_Kmid_DC_hit_position_region3_fiducial_check[i] && FD_Kmid_delta_vz_check[i]) {
            FD_Kmid_all_pass += 1;
            FD_Kmid_all_check[i] = true;
          }
        } else {
      ...
      if (part_status[i] >= 4000) {
        ...
        if (CD_cut_maximum_probability_charged == true) {
          if (CD_Kmid_default_PID_check[i] && CD_Kmid_charge_check[i] && CD_Kmid_maximum_probability_check[i] &&
              CD_Kmid_delta_vz_check[i]) {
            CD_Kmid_all_pass += 1;
            CD_Kmid_all_check[i] = true;
          }
        } else if (CD_cut_beta_vs_p_charged == true) {
          if (CD_Kmid_default_PID_check[i] && CD_Kmid_charge_check[i] && CD_Kmid_beta_check[i] &&
              CD_Kmid_delta_vz_check[i]) {
            CD_Kmid_all_pass += 1;
            CD_Kmid_all_check[i] = true;
          }
      ...
      if (i < BUFFER) {
        ...
        for (int k = 0; k < Npart; k++) {
          if (k < BUFFER) {
            selector = (FD_Kmid_all_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (CD_Kmid_all_check[k] && part_status[i] >= 4000);
  ...
  for (int i = 0; i < BUFFER; i++) {
    if (Km_ind[i] != -1) {
      ...
      double p = sqrt(part_px[Km_ind[i]] * part_px[Km_ind[i]] + part_py[Km_ind[i]] * part_py[Km_ind[i]] +
                      part_pz[Km_ind[i]] * part_pz[Km_ind[i]]);
      ...
      if (abs(part_status[Km_ind[i]]) >= 2000 && abs(part_status[Km_ind[i]]) < 4000) Km_detect[i] = 2;
      if (part_status[Km_ind[i]] >= 4000) Km_detect[i] = 3;
      Km_chi2pid[i] = part_chi2pid[Km_ind[i]];
      if (part_DC_sector[Km_ind[i]] == 1) Km_sector[i] = 1;
      if (part_DC_sector[Km_ind[i]] == 2) Km_sector[i] = 2;
      if (part_DC_sector[Km_ind[i]] == 3) Km_sector[i] = 3;
      if (part_DC_sector[Km_ind[i]] == 4) Km_sector[i] = 4;
      if (part_DC_sector[Km_ind[i]] == 5) Km_sector[i] = 5;
      if (part_DC_sector[Km_ind[i]] == 6) Km_sector[i] = 6;
...
void select_photon(int run) {
  ...
  for (Int_t i = 0; i < Npart; i++) {
    if (i < BUFFER) {
      ...
      if (i < BUFFER) {
        ...
        for (int k = 0; k < Npart; k++) {
          if (k < BUFFER) {
            selector = (FD_photid_all_check[k] && abs(part_status[i]) >= 2000 && abs(part_status[i]) < 4000) ||
                       (FT_photid_all_check[k] && abs(part_status[i]) >= 1000 && abs(part_status[i]) < 2000);
  ...
  for (int i = 0; i < BUFFER; i++) {
    if (g_ind[i] != -1) {
      ...
      double p = sqrt(part_px[g_ind[i]] * part_px[g_ind[i]] + part_py[g_ind[i]] * part_py[g_ind[i]] +
                      part_pz[g_ind[i]] * part_pz[g_ind[i]]);
      p4_phot[i].SetPxPyPzE(part_px[g_ind[i]], part_py[g_ind[i]], part_pz[g_ind[i]], p);
      g_sec[i] = part_Cal_PCAL_sector[g_ind[i]];
      if (abs(part_status[g_ind[i]]) >= 1000 && abs(part_status[g_ind[i]]) < 2000) phot_detect[i] = 1;
      if (abs(part_status[g_ind[i]]) >= 2000 && abs(part_status[g_ind[i]]) < 4000) phot_detect[i] = 2;
      if (part_Cal_PCAL_sector[g_ind[i]] == 1) phot_sector[i] = 1;
      if (part_Cal_PCAL_sector[g_ind[i]] == 2) phot_sector[i] = 2;
      if (part_Cal_PCAL_sector[g_ind[i]] == 3) phot_sector[i] = 3;
      if (part_Cal_PCAL_sector[g_ind[i]] == 4) phot_sector[i] = 4;
      if (part_Cal_PCAL_sector[g_ind[i]] == 5) phot_sector[i] = 5;
      if (part_Cal_PCAL_sector[g_ind[i]] == 6) phot_sector[i] = 6;
    }
  }
}
...
/// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// hit in the FTOF is required for electrons and charged hadrons (basic cut)  --> For now: Selection of good paddels
/// included
///
...
bool basic_FTOF_cut(int j) {
  ...
  if ((part_FTOF_sector_layer1[j] != 0 || part_FTOF_sector_layer2[j] != 0 || part_FTOF_sector_layer3[j] != 0) &&
      paddel_select)
    return true;
  else
    return false;
...
bool EC_sampling_fraction_cut(int j) {
  ...
  for (Int_t k = 0; k < 6; k++) {
    if (part_Cal_PCAL_sector[j] - 1 == k) {
      if (inbending == true && spring2019 == false && simulation == false) {
        mean = p0mean_inb[k] * (1 + part_p[j] / sqrt(part_p[j] * part_p[j] + p1mean_inb[k])) +
               p2mean_inb[k] * part_p[j] + p3mean_inb[k] * part_p[j] * part_p[j];
        sigma = p0sigma_inb[k] + p1sigma_inb[k] / sqrt(part_p[j]) + p2sigma_inb[k] * part_p[j] +
                p3sigma_inb[k] * part_p[j] * part_p[j];
      }
      if (outbending == true && simulation == false) {
        mean = p0mean_outb[k] * (1 + part_p[j] / sqrt(part_p[j] * part_p[j] + p1mean_outb[k])) +
               p2mean_outb[k] * part_p[j] + p3mean_outb[k] * part_p[j] * part_p[j];
        sigma = p0sigma_outb[k] + p1sigma_outb[k] / sqrt(part_p[j]) + p2sigma_outb[k] * part_p[j] +
                p3sigma_outb[k] * part_p[j] * part_p[j];
      }
      if (spring2019 == true && inbending == true && simulation == false) {
        mean = p0mean_spr19[k] * (1 + part_p[j] / sqrt(part_p[j] * part_p[j] + p1mean_spr19[k])) +
               p2mean_spr19[k] * part_p[j] + p3mean_spr19[k] * part_p[j] * part_p[j];
        sigma = p0sigma_spr19[k] + p1sigma_spr19[k] / sqrt(part_p[j]) + p2sigma_spr19[k] * part_p[j] +
                p3sigma_spr19[k] * part_p[j] * part_p[j];
      }
      if (inbending == true && simulation == true) {
        mean = p0mean_mcin[k] * (1 + part_p[j] / sqrt(part_p[j] * part_p[j] + p1mean_mcin[k])) +
               p2mean_mcin[k] * part_p[j] + p3mean_mcin[k] * part_p[j] * part_p[j];
        sigma = p0sigma_mcin[k] + p1sigma_mcin[k] / sqrt(part_p[j]) + p2sigma_mcin[k] * part_p[j] +
                p3sigma_mcin[k] * part_p[j] * part_p[j];
      }
      if (outbending == true && simulation == true) {
        mean = p0mean_mcout[k] * (1 + part_p[j] / sqrt(part_p[j] * part_p[j] + p1mean_mcout[k])) +
               p2mean_mcout[k] * part_p[j] + p3mean_mcout[k] * part_p[j] * part_p[j];
        sigma = p0sigma_mcout[k] + p1sigma_mcout[k] / sqrt(part_p[j]) + p2sigma_mcout[k] * part_p[j] +
  ...
  if (inbending == true && spring2019 == false && simulation == false) {
    if (part_Cal_PCAL_sector[j] == 1)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec1_inb[p_par] - p0_sec1_inb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 2)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec2_inb[p_par] - p0_sec2_inb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 3)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec3_inb[p_par] - p0_sec3_inb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 4)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec4_inb[p_par] - p0_sec4_inb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 5)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec5_inb[p_par] - p0_sec5_inb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 6)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec6_inb[p_par] - p0_sec6_inb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
  }
  if (outbending == true && simulation == false) {
    if (part_Cal_PCAL_sector[j] == 1)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec1_outb[p_par] - p0_sec1_outb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 2)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec2_outb[p_par] - p0_sec2_outb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 3)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec3_outb[p_par] - p0_sec3_outb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 4)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec4_outb[p_par] - p0_sec4_outb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 5)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec5_outb[p_par] - p0_sec5_outb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 6)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec6_outb[p_par] - p0_sec6_outb[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
  }
  if (spring2019 == true && inbending == true && simulation == false) {
    if (part_Cal_PCAL_sector[j] == 1)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec1_spr19[p_par] - p0_sec1_spr19[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 2)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec2_spr19[p_par] - p0_sec2_spr19[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 3)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec3_spr19[p_par] - p0_sec3_spr19[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 4)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec4_spr19[p_par] - p0_sec4_spr19[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 5)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec5_spr19[p_par] - p0_sec5_spr19[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 6)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec6_spr19[p_par] - p0_sec6_spr19[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
  }
  if (inbending == true && simulation == true) {
    if (part_Cal_PCAL_sector[j] == 1)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec1_mcin[p_par] - p0_sec1_mcin[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 2)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec2_mcin[p_par] - p0_sec2_mcin[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 3)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec3_mcin[p_par] - p0_sec3_mcin[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 4)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec4_mcin[p_par] - p0_sec4_mcin[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 5)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec5_mcin[p_par] - p0_sec5_mcin[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 6)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec6_mcin[p_par] - p0_sec6_mcin[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
  }
  if (outbending == true && simulation == true) {
    if (part_Cal_PCAL_sector[j] == 1)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec1_mcout[p_par] - p0_sec1_mcout[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 2)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec2_mcout[p_par] - p0_sec2_mcout[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 3)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec3_mcout[p_par] - p0_sec3_mcout[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 4)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec4_mcout[p_par] - p0_sec4_mcout[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 5)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec5_mcout[p_par] - p0_sec5_mcout[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
    if (part_Cal_PCAL_sector[j] == 6)
      pass_triangle = part_Cal_PCAL_energy[j] / part_p[j] >
                      (p1_sec6_mcout[p_par] - p0_sec6_mcout[p_par] * part_Cal_ECin_energy[j] / part_p[j]);
  }
...
bool FT_eid_energy_vs_radius_cut(int j) { return true; }
...
bool FT_photid_beta_cut(int j, int run) { return true; }
...
void fill_output_vector_pip(void) {
  for (int i = 0; i < BUFFER; i++) {
    if (p4_pip[i].E() > 0) {
      ...
      if (userich) pip_RICHbest.push_back(part_RICH_best[pip_ind[i]]);
    }
  }
}
...
void fill_output_vector_pim(void) {
  for (int i = 0; i < BUFFER; i++) {
    if (p4_pim[i].E() > 0) {
      ...
      if (userich) pim_RICHbest.push_back(part_RICH_best[pim_ind[i]]);
    }
  }
}
...
void fill_output_vector_Kplus(void) {
  for (int i = 0; i < BUFFER; i++) {
    if (p4_Kp[i].E() > 0) {
      ...
      if (userich) Kp_RICHbest.push_back(part_RICH_best[Kp_ind[i]]);
    }
  }
}
...
void fill_output_vector_Kminus(void) {
  for (int i = 0; i < BUFFER; i++) {
    if (p4_Km[i].E() > 0) {
      ...
      if (userich) Km_RICHbest.push_back(part_RICH_best[Km_ind[i]]);
    }
  }
}
...
double GetTheta(int j) { return acos(part_pz[j] / part_p[j]); }

double GetPhi(int j) { return 150 * Pival / 180 + atan2(part_py[j] / part_p[j], part_px[j] / part_p[j]); }
...
double Beta_charged(int j, int run) { return part_beta[j]; }

double Beta_charged_central(int j, int run) { return part_beta[j]; }

double Beta_charged_FT(int j, int run) { return part_beta[j]; }

double Beta_neutral(int j, int run) { return part_beta[j]; }

double Beta_neutral_FT(int j, int run) { return part_beta[j]; }

int determineSector(int i) {
  double phi = 180 / Pival *
               atan2(part_DC_c2y[i] / sqrt(pow(part_DC_c2x[i], 2) + pow(part_DC_c2y[i], 2) + pow(part_DC_c2z[i], 2)),
                     part_DC_c2x[i] / sqrt(pow(part_DC_c2x[i], 2) + pow(part_DC_c2y[i], 2) + pow(part_DC_c2z[i], 2)));
...
double ml_value(int i) {
  /*
      ...
      float part_Cal_PCAL_energy_buffer, part_Cal_ECin_energy_buffer, part_Cal_ECout_energy_buffer,
     part_Cal_energy_total_buffer; float part_Cal_PCAL_time_buffer, part_Cal_ECin_time_buffer,
     part_Cal_ECout_time_buffer; float part_Cal_PCAL_path_buffer, part_Cal_ECin_path_buffer, part_Cal_ECout_path_buffer;
      ...
      {
          reader->BookMVA("DNN",
     "/home/aron/CLAS/analysis/dataset/home/aron/CLAS/analysis/dataset/Km/TMVAClassification_DNN.weights.xml");
      }

      if (!std::isnan(part_Cal_PCAL_energy_buffer) && !std::isnan(part_Cal_ECin_energy_buffer) &&
     !std::isnan(part_Cal_ECout_energy_buffer) && !std::isnan(part_Cal_energy_total_buffer) &&
     !std::isnan(part_Cal_PCAL_time_buffer) && !std::isnan(part_Cal_ECin_time_buffer) &&
     !std::isnan(part_Cal_ECout_time_buffer) && !std::isnan(part_Cal_PCAL_path_buffer) &&
     !std::isnan(part_Cal_ECin_path_buffer) && !std::isnan(part_Cal_ECout_path_buffer) &&
     !std::isnan(part_Cal_PCAL_m2u_buffer) && !std::isnan(part_Cal_ECin_m2u_buffer) &&
     !std::isnan(part_Cal_ECout_m2u_buffer) && !std::isnan(part_Cal_PCAL_m2v_buffer) &&
     !std::isnan(part_Cal_ECin_m2v_buffer) && !std::isnan(part_Cal_ECout_m2v_buffer) &&
     !std::isnan(part_Cal_PCAL_m2w_buffer) && !std::isnan(part_Cal_ECin_m2w_buffer) &&
     !std::isnan(part_Cal_ECout_m2w_buffer) && !std::isnan(part_Cal_PCAL_m3u_buffer) &&
     !std::isnan(part_Cal_ECin_m3u_buffer) && !std::isnan(part_Cal_ECout_m3u_buffer) &&
     !std::isnan(part_Cal_PCAL_m3v_buffer) && !std::isnan(part_Cal_ECin_m3v_buffer) &&
     !std::isnan(part_Cal_ECout_m3v_buffer) && !std::isnan(part_Cal_PCAL_m3w_buffer) &&
     !std::isnan(part_Cal_ECin_m3w_buffer) && !std::isnan(part_Cal_ECout_m3w_buffer) &&
     !std::isnan(part_CC_HTCC_nphe_buffer) && !std::isnan(part_CC_HTCC_time_buffer) &&
     !std::isnan(part_CC_HTCC_path_buffer) && !std::isnan(part_beta_buffer) && !std::isnan(part_p_buffer) &&
     part_theta_buffer > 0.09 && part_theta_buffer < 0.61 && part_beta_buffer < 1.1 && part_beta_buffer > 0. &&
     part_Cal_PCAL_energy_buffer >= 0. && part_Cal_ECin_energy_buffer >= 0. && part_Cal_ECout_energy_buffer >= 0. &&
     part_Cal_energy_total_buffer < 0.4 && part_Cal_PCAL_time_buffer >= 0. && part_Cal_ECin_time_buffer >= 0. &&
     part_Cal_ECout_time_buffer >= 0. && part_Cal_PCAL_path_buffer >= 0. && part_Cal_ECin_path_buffer >= 0. &&
     part_Cal_ECout_path_buffer >= 0. && part_Cal_PCAL_m2u_buffer >= 0. && part_Cal_ECin_m2u_buffer >= 0. &&
     part_Cal_ECout_m2u_buffer >= 0. && part_Cal_PCAL_m2w_buffer >= 0. && part_Cal_ECin_m2w_buffer >= 0. &&
     part_Cal_ECout_m2w_buffer >= 0. && part_Cal_PCAL_m2v_buffer >= 0. && part_Cal_ECin_m2v_buffer >= 0. &&
     part_Cal_ECout_m2v_buffer >= 0. && part_CC_HTCC_nphe_buffer >= 0. && part_CC_HTCC_time_buffer >= 0. &&
     part_CC_HTCC_path_buffer >= 0.)
      {
...
if (!std::isnan(part_Cal_PCAL_energy[i]) && !std::isnan(part_Cal_ECin_energy[i]) &&
!std::isnan(part_Cal_ECout_energy[i]) && !std::isnan(part_Cal_energy_total[i]) && !std::isnan(part_Cal_PCAL_time[i]) &&
!std::isnan(part_Cal_ECin_time[i]) && !std::isnan(part_Cal_ECout_time[i]) && !std::isnan(part_Cal_PCAL_path[i]) &&
!std::isnan(part_Cal_ECin_path[i]) && !std::isnan(part_Cal_ECout_path[i]) && !std::isnan(part_Cal_PCAL_m2u[i]) &&
!std::isnan(part_Cal_ECin_m2u[i]) && !std::isnan(part_Cal_ECout_m2u[i]) && !std::isnan(part_Cal_PCAL_m2v[i]) &&
!std::isnan(part_Cal_ECin_m2v[i]) && !std::isnan(part_Cal_ECout_m2v[i]) && !std::isnan(part_Cal_PCAL_m2w[i]) &&
!std::isnan(part_Cal_ECin_m2w[i]) && !std::isnan(part_Cal_ECout_m2w[i]) && !std::isnan(part_Cal_PCAL_m3u[i]) &&
!std::isnan(part_Cal_ECin_m3u[i]) && !std::isnan(part_Cal_ECout_m3u[i]) && !std::isnan(part_Cal_PCAL_m3v[i]) &&
!std::isnan(part_Cal_ECin_m3v[i]) && !std::isnan(part_Cal_ECout_m3v[i]) && !std::isnan(part_Cal_PCAL_m3w[i]) &&
!std::isnan(part_Cal_ECin_m3w[i]) && !std::isnan(part_Cal_ECout_m3w[i]) && !std::isnan(part_CC_HTCC_nphe[i]) &&
!std::isnan(part_CC_HTCC_time[i]) && !std::isnan(part_CC_HTCC_path[i]) && !std::isnan(part_beta[i]) &&
!std::isnan(part_p[i]) && part_theta[i] > 0.09 && part_theta[i] < 0.61 && part_beta[i] < 1.1 && part_beta[i] > 0. &&
part_Cal_PCAL_energy[i] >= 0. && part_Cal_ECin_energy[i] >= 0. && part_Cal_ECout_energy[i] >= 0. &&
part_Cal_energy_total[i] < 0.4 && part_Cal_PCAL_time[i] >= 0. && part_Cal_ECin_time[i] >= 0. && part_Cal_ECout_time[i]
>= 0. && part_Cal_PCAL_path[i] >= 0. && part_Cal_ECin_path[i] >= 0. && part_Cal_ECout_path[i] >= 0. &&
part_Cal_PCAL_m2u[i] >= 0. && part_Cal_ECin_m2u[i] >= 0. && part_Cal_ECout_m2u[i] >= 0. && part_Cal_PCAL_m2w[i] >= 0. &&
part_Cal_ECin_m2w[i] >= 0. && part_Cal_ECout_m2w[i] >= 0. && part_Cal_PCAL_m2v[i] >= 0. && part_Cal_ECin_m2v[i] >= 0. &&
part_Cal_ECout_m2v[i] >= 0. && part_CC_HTCC_nphe[i] >= 0. && part_CC_HTCC_time[i] >= 0. && part_CC_HTCC_path[i] >= 0.)
{
    std::vector<std::string> inputVars{"part_beta", "part_p", "part_Cal_PCAL_energy", "part_Cal_ECin_energy",
"part_Cal_ECout_energy", "part_Cal_energy_total", "part_Cal_PCAL_path/part_Cal_PCAL_time",
"part_Cal_ECin_path/part_Cal_ECin_time", "part_Cal_ECout_path/part_Cal_ECout_time", "part_Cal_PCAL_m2u",
"part_Cal_ECin_m2u", "part_Cal_ECout_m2u", "part_Cal_PCAL_m2v", "part_Cal_ECin_m2v", "part_Cal_ECout_m2v",
"part_Cal_PCAL_m2w", "part_Cal_ECin_m2w", "part_Cal_ECout_m2w", "part_Cal_PCAL_m3u", "part_Cal_ECin_m3u",
"part_Cal_ECout_m3u", "part_Cal_PCAL_m3v", "part_Cal_ECin_m3v", "part_Cal_ECout_m3v", "part_Cal_PCAL_m3w",
"part_Cal_ECin_m3w", "part_Cal_ECout_m3w", "part_CC_HTCC_nphe", "part_CC_HTCC_path/part_CC_HTCC_time", "part_chi2pid",
"part_pid", "part_FTOF_energy", "part_FTOF_path/part_FTOF_time", "part_FTOF_energy_layer1",
"part_FTOF_path_layer1/part_FTOF_time_layer1", "part_FTOF_energy_layer3",
"part_FTOF_path_layer3/part_FTOF_time_layer3"};

    const ReadDNN *DNNResponse = new ReadDNN(inputVars);

    const std::vector<double> inputVec{part_beta[i], part_p[i], part_Cal_PCAL_energy[i], part_Cal_ECin_energy[i],
part_Cal_ECout_energy[i], part_Cal_energy_total[i], part_Cal_PCAL_velocity, part_Cal_ECin_velocity,
part_Cal_ECout_velocity, part_Cal_PCAL_m2u[i], part_Cal_ECin_m2u[i], part_Cal_ECout_m2u[i], part_Cal_PCAL_m2v[i],
part_Cal_ECin_m2v[i], part_Cal_ECout_m2v[i], part_Cal_PCAL_m2w[i], part_Cal_ECin_m2w[i], part_Cal_ECout_m2w[i],
part_Cal_PCAL_m3u[i], part_Cal_ECin_m3u[i], part_Cal_ECout_m3u[i], part_Cal_PCAL_m3v[i], part_Cal_ECin_m3v[i],
part_Cal_ECout_m3v[i], part_Cal_PCAL_m3w[i], part_Cal_ECin_m3w[i], part_Cal_ECout_m3w[i], part_CC_HTCC_nphe_float,
part_CC_HTCC_velocity, part_chi2pid[i], part_pid_float, part_FTOF_energy[i], part_FTOF_velocity,
part_FTOF_energy_layer1[i], part_FTOF_velocity_layer1, part_FTOF_energy_layer3[i], part_FTOF_velocity_layer3};
