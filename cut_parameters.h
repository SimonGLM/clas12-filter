...
namespace cuts::parameters {
  ...
  namespace PCAL_fiducial {
    ...
    const std::vector<std::vector<std::array<vw_bounds, 6>>> FIDUCIAL = {
        // inbending
        {
            // Loose
            {{
    ...
    // Fiducial parameters for photons
    const std::vector<std::vector<std::array<vw_bounds, 6>>> PHOT_FIDUCIAL = {
        // inbending
        {
            // Loose
            {{
