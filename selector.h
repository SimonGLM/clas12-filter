...
namespace selectors {
  // Selector setting defaults, can be overwriten anywhere after #include "selector.h"
  ...
  namespace impl {
    bool electron(SelectorContext& ctx, clas12::region_particle* p, bool inbending) {
    ...
    bool proton(SelectorContext& ctx, clas12::region_particle* p, bool inbending, double reference_vertex_z) {
    ...
    bool neutron(SelectorContext& ctx, clas12::region_particle* p, bool inbending, double reference_vertex_z) {
    ...
    bool piplus(SelectorContext& ctx, clas12::region_particle* p, bool inbending, double reference_vertex_z) {
    ...
    bool piminus(SelectorContext& ctx, clas12::region_particle* p, bool inbending, double reference_vertex_z) {
      // CHECK_CUT(ctx,"PID_cut(-211)", cuts::generic::impl::PID_cut, p, 211);
      // CHECK_CUT(ctx, "charge_cut(-1)", cuts::generic::impl::charge_cut, p, -1);
    ...
    bool Kplus(SelectorContext& ctx, clas12::region_particle* p, bool inbending, double reference_vertex_z) {
    ...
    bool Kminus(SelectorContext& ctx, clas12::region_particle* p, bool inbending, double reference_vertex_z) {
      // CHECK_CUT(ctx, "PID_cut(-321)", cuts::generic::impl::PID_cut, p, -321);
      // CHECK_CUT(ctx, "charge_cut(-1)", cuts::generic::impl::charge_cut, p, -1);
    ...
    bool photon(SelectorContext& ctx, clas12::region_particle* p, bool inbending) {
  ...
  inline void record_selector_cuts(const std::string& selector_name, const SelectorContext& ctx, bool result) {
  ...
  inline bool electron(clas12::region_particle* p, bool inbending) {
    SelectorContext ctx(evaluation_mode);
